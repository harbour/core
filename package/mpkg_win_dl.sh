...
openssl dgst -sha256 pack.7z | grep -q f9191a81fedbc42eae6249b838ffbab24e43ab17dcc47b7902bbacde4998b8ec
7z x -y "-o${HB_DL_ROOT}" pack.7z > /dev/null

curl -fsS -o pack.7z -L --proto-redir =https "https://dl.bintray.com/vszakats/generic/openssl-${VER_OPENSSL}-win64-mingw.7z"
openssl dgst -sha256 pack.7z | grep -q 82d25df66124ca94b3c52545a0cc3266f2db8f1bcc758709d922aaa32477f5c0
7z x -y "-o${HB_DL_ROOT}" pack.7z > /dev/null
