# Welcome to Harbour
[![Build Status](https://travis-ci.org/vszakats/harbour-core.svg)](https://travis-ci.org/vszakats/harbour-core) [![Build status](https://ci.appveyor.com/api/projects/status/d338bal77amxtyep?svg=true)](https://ci.appveyor.com/project/vsz/harbour-core) [![Coverity Status](https://scan.coverity.com/projects/3208/badge.svg)](https://scan.coverity.com/projects/3208) [![Total views](https://sourcegraph.com/api/repos/github.com/vszakats/harbour-core/counters/views.svg)](https://sourcegraph.com/github.com/vszakats/harbour-core)
...
## Special
   ...
   - `HB_COMPILER_VER=[<ver>]`
     ...
     `<ver>` format:
         ...
         F.e. mingw: 0409 for 4.9.x, msvc: 1900 for 19.00.x
...
# Harbour Links
  ...
  * [How to contribute](CONTRIBUTING.md) ([Flowchart](http://beta.gitflowchart.com/chart/github/vszakats/harbour-core))
