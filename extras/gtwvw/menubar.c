...
HB_FUNC( WVW_APPENDMENU )
{
   ...
   hb_retl( AppendMenu( ( HMENU ) HB_PARHANDLE( 1 ), ( UINT ) hb_parnint( 2 ), ( UINT_PTR ) hb_parnint( 3 ), szCaption ) );
}

HB_FUNC( WVW_DELETEMENU )
{
   hb_retl( DeleteMenu( ( HMENU ) HB_PARHANDLE( 1 ), ( UINT ) hb_parnint( 2 ), ( UINT ) hb_parnint( 3 ) ) );
}
...
{
   hb_retl( EnableMenuItem( ( HMENU ) HB_PARHANDLE( 1 ), ( UINT ) hb_parnint( 2 ), ( UINT ) hb_parnint( 3 ) ) );
}
