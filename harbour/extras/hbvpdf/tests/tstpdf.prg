...
PROCEDURE Main()
   ...
   oPdf:EditOnHeader()
   oPdf:Image( "files" + hb_ps() + "color.tif", 0, 0, "M" )
   oPdf:EditOffHeader()
   ...
   nWidth := 90
   nTab   := 0
   cText  := MemoRead( "files" + hb_ps() + "test.txt" )
   ...
   oPdf:Text( cText,  34, 100,    nWidth, nTab, 3, "R", Chr( 253 ) + Chr( 0 ) + Chr( 128 ) + Chr( 128 ) )  //, pdfTextCount( memoread( "files" + hb_ps() + "test.txt" ),  33, 100,    nWidth, nTab, 3, "R" )
   oPdf:Text( cText,  41, 100,    nWidth, nTab, 2, "R", Chr( 253 ) + Chr( 0 ) + Chr( 191 ) + Chr( 255 ) )  //, pdfTextCount( memoread( "files" + hb_ps() + "test.txt" ),  40, 100,    nWidth, nTab, 2, "R" )
   oPdf:Text( cText,  48, 100,    nWidth, nTab, 1, "R", Chr( 253 ) + Chr( 244 ) + Chr( 164 ) + Chr( 96 ) ) //, pdfTextCount( memoread( "files" + hb_ps() + "test.txt" ),  47, 100,    nWidth, nTab, 1, "R" )
   oPdf:Text( cText,  55,  35,    nWidth, nTab, 4, "R", Chr( 253 ) + Chr( 0 ) + Chr( 0 ) + Chr( 0 ) )      //, pdfTextCount( memoread( "files" + hb_ps() + "test.txt" ),  54,  35,    nWidth, nTab, 4, "R" )
   ...
   oPdf:Image( "files" + hb_ps() + "color.jpg", 0, 0, "M" ) // file, row, col, units, height, width
