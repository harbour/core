...
METHOD IdeActions:buildMainMenu()
   ...
   oSubMenu:addItem( { ::getAction( "DeleteLine"          ), {|| oIde:execAction( "DeleteLine"     ) } } )
   ...
   oSubMenu:addItem( { ::getAction( "BlockIndentR"        ), {|| oIde:execAction( "BlockIndentR"   ) } } )
   oSubMenu:addItem( { ::getAction( "BlockIndentL"        ), {|| oIde:execAction( "BlockIndentL"   ) } } )
   hbide_menuAddSep( oSubMenu )
   oSubMenu2 := XbpMenu():new( oSubMenu ):create()
