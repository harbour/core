...
HB_FUNC( HPDF_NEW )
{
   hb_retnl( (long) HPDF_New( NULL, NULL ) );
}
//----------------------------------------------------------------------//
// HPdf_Free( hDoc ) -> NIL
//
...
HB_FUNC( HPDF_NEWDOC )
{
   hb_retnl( (long) HPDF_NewDoc( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   HPDF_FreeDoc( (HPDF_Doc) hb_parnl( 1 ) );
}
//----------------------------------------------------------------------//
// HPdf_FreeDocAll() -> NIL
//
...
{
   HPDF_FreeDocAll( (HPDF_Doc) hb_parnl( 1 ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SaveToFile( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SaveToStream( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_GetStreamSize( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_ResetStream( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
HB_FUNC( HPDF_HASDOC )
{
   hb_retl( HPDF_HasDoc( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SetErrorHandler( (HPDF_Doc) hb_parnl( 1 ), (HPDF_Error_Handler) hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_GetError( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   HPDF_ResetError( (HPDF_Doc) hb_parnl( 1 ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SetPagesConfiguration( (HPDF_Doc) hb_parnl( 1 ), hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SetPageLayout( (HPDF_Doc) hb_parnl( 1 ), (HPDF_PageLayout) hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_GetPageLayout( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SetPageMode( (HPDF_Doc) hb_parnl( 1 ), (HPDF_PageMode) hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_GetPageMode( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SetOpenAction( (HPDF_Doc) hb_parnl( 1 ), (HPDF_Destination) hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_GetCurrentPage( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_AddPage( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_InsertPage( (HPDF_Doc) hb_parnl( 1 ), (HPDF_Page)hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_GetFont( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ), hb_parc( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retc( HPDF_LoadType1FontFromFile( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ), hb_parc( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retc( HPDF_LoadTTFontFromFile( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ), hb_parl( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retc( HPDF_LoadTTFontFromFile2( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ), hb_parni( 3 ), hb_parl( 4 ) ) );
}
//----------------------------------------------------------------------//
...
//----------------------------------------------------------------------//
// HPdf_UseJPFonts( hDoc ) -> hSttaus
//
HB_FUNC( HPDF_USEJPFONTS )
{
   hb_retnl( (long) HPDF_UseJPFonts( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
// HPdf_UseKRFonts( hDoc ) -> hSttaus
//
HB_FUNC( HPDF_USEKRFONTS )
{
   hb_retnl( (long) HPDF_UseKRFonts( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_UseCNSFonts( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_UseCNTFonts( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_CreateExtGState( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_CreateOutline( (HPDF_Doc) hb_parnl( 1 ),(HPDF_Outline) hb_parnl( 2 ), hb_parc( 3 ), (HPDF_Encoder) hb_parnl( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_GetEncoder( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_GetCurrentEncoder( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
// HPdf_SetCurrentEncoder( hDoc, hEncoder ) -> hOutline
//
HB_FUNC( HPDF_SETCURRENTENCODER )
{
   hb_retnl( (long) HPDF_SetCurrentEncoder( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_UseJPEncodings( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_UseKREncodings( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_UseCNSEncodings( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_UseCNTEncodings( (HPDF_Doc) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_LoadPngImageFromFile( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_LoadPngImageFromFile2( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_LoadRawImageFromFile( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ), hb_parni( 3 ), hb_parni( 4 ), (HPDF_ColorSpace) hb_parni( 5 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_LoadJpegImageFromFile( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
// HPdf_SetInfoAttr( hDoc, nInfoType, cInfo ) -> hSttaus
//     nInfoType ==
// HPDF_INFO_AUTHOR
// HPDF_INFO_CREATOR
// HPDF_INFO_TITLE
...
{
   hb_retnl( (long) HPDF_SetInfoAttr( (HPDF_Doc) hb_parnl( 1 ), (HPDF_InfoType) hb_parni( 2 ), hb_parc( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retc( HPDF_GetInfoAttr( (HPDF_Doc) hb_parnl( 1 ), (HPDF_InfoType) hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
HB_FUNC( HPDF_SETINFODATEATTR )
{
   ...
   hb_retnl( (long) HPDF_SetInfoDateAttr( (HPDF_Doc) hb_parnl( 1 ), (HPDF_InfoType) hb_parni( 2 ), date ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SetPassword( (HPDF_Doc) hb_parnl( 1 ), hb_parc( 2 ), hb_parc( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SetPermission( (HPDF_Doc) hb_parnl( 1 ), hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
// HPdf_SetEncryptionMode( hDoc, nEncMode, nKeyLen ) -> hSttaus
//     nEncMode ==
...
{
   hb_retnl( (long) HPDF_SetEncryptionMode( (HPDF_Doc) hb_parnl( 1 ), (HPDF_EncryptMode) hb_parni( 2 ), hb_parni( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_SetCompressionMode( (HPDF_Doc) hb_parnl( 1 ), hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetWidth( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetHeight( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
// HPdf_Page_SetSize( hPage, nSize, nOrientation = 1 Portrait, 2 Landscape ) -> hStatis
//     nSize ==
...
{
   hb_retnl( (long) HPDF_Page_SetSize( (HPDF_Page) hb_parnl( 1 ), (HPDF_PageSizes) hb_parni( 2 ), (HPDF_PageDirection) hb_parni( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetRotate( (HPDF_Page) hb_parnl( 1 ), hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetWidth( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetHeight( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_CreateDestination( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
HB_FUNC( HPDF_PAGE_CREATETEXTANNOT )
{
   ...
   hb_retnl( (long) HPDF_Page_CreateTextAnnot( (HPDF_Page) hb_parnl( 1 ), rc, hb_parc( 3 ), (HPDF_Encoder) hb_parnl( 4 ) ) );
}
//----------------------------------------------------------------------//
...
HB_FUNC( HPDF_PAGE_CREATELINKANNOT )
{
   ...
   hb_retnl( (long) HPDF_Page_CreateLinkAnnot( (HPDF_Page) hb_parnl( 1 ), rc, (HPDF_Destination) hb_parnl( 3 ) ) );
}
//----------------------------------------------------------------------//
...
HB_FUNC( HPDF_PAGE_CREATEURILINKANNOT )
{
   ...
   hb_retnl( (long) HPDF_Page_CreateURILinkAnnot( (HPDF_Page) hb_parnl( 1 ), rc, hb_parc( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_TextWidth( (HPDF_Page) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_MeasureText( (HPDF_Page) hb_parnl( 1 ), hb_parc( 2 ), (HPDF_REAL) hb_parnd( 3 ), hb_parl( 4 ), NULL ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_GetGMode( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_GetCurrentFont( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetCurrentFontSize( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetLineWidth( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_GetLineCap( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_GetLineJoin( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_GetMiterLimit( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetFlat( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetCharSpace( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetWordSpace( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetHorizontalScalling( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetTextLeading( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetTextRenderingMode( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetTextRise( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetGrayFill( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetGrayStroke( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetStrokingColorSpace( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnd( (long) HPDF_Page_GetFillingColorSpace( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_Page_GetGStateDepth( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetSlideShow( (HPDF_Page) hb_parnl( 1 ), (HPDF_TransitionStyle) hb_parni( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ) ) );
}
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetLineWidth( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetLineCap( (HPDF_Page) hb_parnl( 1 ), (HPDF_LineCap) hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetLineJoin( (HPDF_Page) hb_parnl( 1 ), (HPDF_LineJoin) hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetMiterLimit( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
HB_FUNC( HPDF_PAGE_SETDASH )
{
   ...
   hb_retnl( (long) HPDF_Page_SetDash( (HPDF_Page) hb_parnl( 1 ), dash.ptn, nPtns, hb_parni( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetExtGState( (HPDF_Page) hb_parnl( 1 ), (HPDF_ExtGState) hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_GSave( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_GRestore( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Concat( (HPDF_Page) hb_parnl( 1 ),
...
{
   hb_retnl( (long) HPDF_Page_MoveTo( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_LineTo( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_CurveTo( (HPDF_Page) hb_parnl( 1 ),
                                                   (HPDF_REAL) hb_parnd( 2 ),
                                                   (HPDF_REAL) hb_parnd( 3 ),
                                                   (HPDF_REAL) hb_parnd( 4 ),
                                                   (HPDF_REAL) hb_parnd( 5 ),
...
{
   hb_retnl( (long) HPDF_Page_CurveTo2( (HPDF_Page) hb_parnl( 1 ),
                                                    (HPDF_REAL) hb_parnd( 2 ),
                                                    (HPDF_REAL) hb_parnd( 3 ),
                                                    (HPDF_REAL) hb_parnd( 4 ),
                                                    (HPDF_REAL) hb_parnd( 5 )
...
{
   hb_retnl( (long) HPDF_Page_CurveTo3( (HPDF_Page) hb_parnl( 1 ),
                                                    (HPDF_REAL) hb_parnd( 2 ),
                                                    (HPDF_REAL) hb_parnd( 3 ),
                                                    (HPDF_REAL) hb_parnd( 4 ),
                                                    (HPDF_REAL) hb_parnd( 5 )
...
{
   hb_retnl( (long) HPDF_Page_ClosePath( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Rectangle( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 )  ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Stroke( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_ClosePathStroke( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetFontAndSize( (HPDF_Page) hb_parnl( 1 ), (HPDF_Font) hb_parnl( 2 ), (HPDF_REAL) hb_parnd( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_BeginText( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_EndText( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_TextOut( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), hb_parc( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_MoveTextPos( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_ShowText( (HPDF_Page) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Fill( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Eofill( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_FillStroke( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_EofillStroke( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_ClosePathFillStroke( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_ClosePathEofillStroke( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_EndPath( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Clip( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Eoclip( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetCharSpace( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetWordSpace( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetHorizontalScalling( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetTextLeading( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetTextRenderingMode( (HPDF_Page) hb_parnl( 1 ), (HPDF_TextRenderingMode) hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetTextRise( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_MoveTextPos2( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetTextMatrix( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 ), (HPDF_REAL) hb_parnd( 6 ), (HPDF_REAL) hb_parnd( 7 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_MoveToNextLine( (HPDF_Page) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_ShowTextNextLine( (HPDF_Page) hb_parnl( 1 ), hb_parc( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_ShowTextNextLineEx( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), hb_parc( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetGrayFill( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetGrayStroke( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetRGBFill( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetRGBStroke( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetCMYKFill( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_SetCMYKStroke( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_ExecuteXObject( (HPDF_Page) hb_parnl( 1 ), (HPDF_Image) hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_DrawImage( (HPDF_Page) hb_parnl( 1 ), (HPDF_Image) hb_parnl( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 ), (HPDF_REAL) hb_parnd( 6 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Circle( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Arc( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 ), (HPDF_REAL) hb_parnd( 6 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_Ellipse( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Page_TextRect( (HPDF_Page) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 ), hb_parc( 6 ), (HPDF_TextAlignment) hb_parni( 7 ), NULL ) );
}
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
...
{
   hb_retc( HPDF_Font_GetFontName( (HPDF_Font) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retc( HPDF_Font_GetEncodingName( (HPDF_Font) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Font_GetUnicodeWidth( (HPDF_Font) hb_parnl( 1 ), (HPDF_UNICODE)hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_Font_GetAscent( (HPDF_Font) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_Font_GetDescent( (HPDF_Font) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Font_GetXHeight( (HPDF_Font) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Font_GetCapHeight( (HPDF_Font) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_Encoder_GetType( (HPDF_Encoder) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_Encoder_GetByteType( (HPDF_Encoder) hb_parnl( 1 ), hb_parc( 2 ), hb_parni( 3 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_Encoder_GetUnicode( (HPDF_Encoder) hb_parnl( 1 ), hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( (int) HPDF_Encoder_GetWritingMode( (HPDF_Encoder) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_LinkAnnot_SetHighlightMode( (HPDF_Annotation) hb_parnl( 1 ), (HPDF_AnnotHighlightMode) hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_LinkAnnot_SetBorderStyle( (HPDF_Annotation) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), hb_parni( 3 ), hb_parni( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_TextAnnot_SetIcon( (HPDF_Annotation) hb_parnl( 1 ), (HPDF_AnnotIcon) hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_TextAnnot_SetOpened( (HPDF_Annotation) hb_parnl( 1 ), hb_parl( 2 ) ) );
}
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Outline_SetOpened( (HPDF_Outline) hb_parnl( 1 ), hb_parl( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Outline_SetDestination( (HPDF_Outline) hb_parnl( 1 ), (HPDF_Destination) hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Destination_SetXYZ( (HPDF_Destination) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Destination_SetFit( (HPDF_Destination) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Destination_SetFitH( (HPDF_Destination) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Destination_SetFitV( (HPDF_Destination) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Destination_SetFitR( (HPDF_Destination) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ), (HPDF_REAL) hb_parnd( 3 ), (HPDF_REAL) hb_parnd( 4 ), (HPDF_REAL) hb_parnd( 5 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Destination_SetFitB( (HPDF_Destination) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Destination_SetFitBH( (HPDF_Destination) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Destination_SetFitBV( (HPDF_Destination) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
...
{
   hb_retni( HPDF_Image_GetWidth( (HPDF_Image) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( HPDF_Image_GetHeight( (HPDF_Image) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retni( HPDF_Image_GetBitsPerComponent( (HPDF_Image) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retc( HPDF_Image_GetColorSpace( (HPDF_Image) hb_parnl( 1 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_Image_SetColorMask( (HPDF_Image) hb_parnl( 1 ),
                                                          hb_parni( 2 ),
                                                          hb_parni( 3 ),
                                                          hb_parni( 4 ),
                                                          hb_parni( 5 ),
...
{
   hb_retnl( (long) HPDF_Image_SetMaskImage( (HPDF_Image) hb_parnl( 1 ), (HPDF_Image) hb_parnl( 2 ) ) );
}
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_ExtGState_SetAlphaStroke( (HPDF_ExtGState) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_ExtGState_SetAlphaFill( (HPDF_ExtGState) hb_parnl( 1 ), (HPDF_REAL) hb_parnd( 2 ) ) );
}
//----------------------------------------------------------------------//
...
{
   hb_retnl( (long) HPDF_ExtGState_SetBlendMode( (HPDF_ExtGState) hb_parnl( 1 ), (HPDF_BlendMode) hb_parni( 2 ) ) );
}
//----------------------------------------------------------------------//
