...
#define wapi_par_HMENU( n )           ( ( HMENU            ) hb_parptr( n ) )
#define wapi_par_HACCEL( n )          ( ( HACCEL           ) hb_parptr( n ) )
...
#define wapi_ret_UINT( n )            ( hb_retnint( n ) )
#define wapi_ret_LONG( n )            ( hb_retnl( n ) )
#define wapi_ret_WORD( n )            ( hb_retnl( n ) )
#define wapi_ret_DWORD( n )           ( hb_retnint( n ) )

#define wapi_ret_HANDLE( h )          ( hb_retptr( h ) )
#define wapi_ret_HWND( h )            ( hb_retptr( h ) )
#define wapi_ret_HMENU( h )           ( hb_retptr( h ) )
#define wapi_ret_HACCEL( h )          ( hb_retptr( h ) )
