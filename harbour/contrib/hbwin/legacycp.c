...
HB_FUNC_EXTERN( WIN_GETDEFAULTPRINTER ) ; HB_FUNC( GETDEFAULTPRINTER ) { HB_FUNC_EXEC( WIN_GETDEFAULTPRINTER ); }
...
HB_FUNC_EXTERN( WIN_GETPRINTERS       ) ; HB_FUNC( GETPRINTERS       ) { HB_FUNC_EXEC( WIN_GETPRINTERS       ); }
HB_FUNC_EXTERN( WIN_SETDEFAULTPRINTER ) ; HB_FUNC( SETDEFAULTPRINTER ) { HB_FUNC_EXEC( WIN_SETDEFAULTPRINTER ); }
