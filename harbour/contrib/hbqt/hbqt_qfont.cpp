...
{
   hb_retl( hbqt_par_QFont( 1 )->fromString( hbqt_par_QString( 1 ) ) );
}
...
{
   hbqt_par_QFont( 1 )->setBold( hb_parl( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setCapitalization( ( QFont::Capitalization ) hb_parni( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setFamily( hbqt_par_QString( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setFixedPitch( hb_parl( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setItalic( hb_parl( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setKerning( hb_parl( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setLetterSpacing( ( QFont::SpacingType ) hb_parni( 1 ), hb_parnd( 2 ) );
}
...
{
   hbqt_par_QFont( 1 )->setOverline( hb_parl( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setPixelSize( hb_parni( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setPointSize( hb_parni( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setPointSizeF( hb_parnd( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setRawMode( hb_parl( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setRawName( hbqt_par_QString( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setStretch( hb_parni( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setStrikeOut( hb_parl( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setStyle( ( QFont::Style ) hb_parni( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setStyleHint( ( QFont::StyleHint ) hb_parni( 1 ), ( QFont::StyleStrategy ) hb_parni( 2 ) );
}
...
{
   hbqt_par_QFont( 1 )->setStyleStrategy( ( QFont::StyleStrategy ) hb_parni( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setUnderline( hb_parl( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setWeight( hb_parni( 1 ) );
}
...
{
   hbqt_par_QFont( 1 )->setWordSpacing( hb_parnd( 1 ) );
}
