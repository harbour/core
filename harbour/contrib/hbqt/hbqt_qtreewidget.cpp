...
{
   hb_retptr( ( QTreeWidgetItem* ) hbqt_par_QTreeWidget( 1 )->itemAt( hbqt_const_QPoint( 2 ) ) );
}
...
{
   hbqt_ret_QRect( hbqt_par_QTreeWidget( 1 )->visualItemRect( hbqt_par_QTreeWidgetItem( 2 ) ) );
}
