...
{
   hbqt_par_QTextDocument( 1 )->drawContents( hbqt_par_QPainter( 2 ), *hbqt_par_QRectF( 3 ) );
}
...
{
   hb_retc( hbqt_par_QTextDocument( 1 )->toHtml( *hbqt_par_QByteArray( 2 ) ).toLatin1().data() );
}
