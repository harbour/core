...
QT_G_FUNC( release_QStyleOptionTabBarBase )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QStyleOptionTabBarBase      Object deleted!" ) );
         ...
         hbqt_debug( "  YES release_QStyleOptionTabBarBase      %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
      #endif
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QStyleOptionTabBarBase" );
      #endif
   }
}
...
void * gcAllocate_QStyleOptionTabBarBase( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QStyleOptionTabBarBase      %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
