...
QT_G_FUNC( hbqt_gcRelease_QStyleOptionDockWidget )
{
   ...
   HB_TRACE( HB_TR_DEBUG, ( "hbqt_gcRelease_QStyleOptionDockWidget       p=%p", p ) );
   HB_TRACE( HB_TR_DEBUG, ( "hbqt_gcRelease_QStyleOptionDockWidget      ph=%p", p->ph ) );

   if( p && p->ph )
   {
      delete ( ( QStyleOptionDockWidget * ) p->ph );
      p->ph = NULL;
      HB_TRACE( HB_TR_DEBUG, ( "YES hbqt_gcRelease_QStyleOptionDockWidget      Object deleted! %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() ) );
   }
   else
   {
      HB_TRACE( HB_TR_DEBUG, ( "DEL hbqt_gcRelease_QStyleOptionDockWidget      Object Already deleted!" ) );
   }
}
...
void * hbqt_gcAllocate_QStyleOptionDockWidget( void * pObj )
{
   ...
   HB_TRACE( HB_TR_DEBUG, ( "          new_QStyleOptionDockWidget      %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() ) );
   return( p );
}
