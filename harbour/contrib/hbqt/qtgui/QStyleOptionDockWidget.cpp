...
QT_G_FUNC( release_QStyleOptionDockWidget )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QStyleOptionDockWidget      Object deleted!" ) );
         ...
         hbqt_debug( "  YES release_QStyleOptionDockWidget      %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
      #endif
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QStyleOptionDockWidget" );
      #endif
   }
}
...
void * gcAllocate_QStyleOptionDockWidget( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QStyleOptionDockWidget      %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
