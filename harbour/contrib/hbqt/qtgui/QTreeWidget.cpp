...
QT_G_FUNC( release_QTreeWidget )
{
   ...
   if( p && p->ph && p->pq )
   {
      ...
      if( ( QString ) m->className() != ( QString ) "QObject" )
      {
         ...
         HB_TRACE( HB_TR_DEBUG, ( "release_QTreeWidget                 Object deleted!" ) );
            ...
            hbqt_debug( "  YES release_QTreeWidget                 %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
         #endif
      }
      else
      {
         ...
         #if defined( __HB_DEBUG__ )
            hbqt_debug( "  NO  release_QTreeWidget" );
         #endif
      }
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QTreeWidget" );
      #endif
   }
}
...
void * gcAllocate_QTreeWidget( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QTreeWidget                 %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
