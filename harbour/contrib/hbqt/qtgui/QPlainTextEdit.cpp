...
QT_G_FUNC( release_QPlainTextEdit )
{
   ...
   if( p && p->ph && p->pq )
   {
      ...
      if( ( QString ) m->className() != ( QString ) "QObject" )
      {
         ...
         p->ph = NULL;
         HB_TRACE( HB_TR_DEBUG, ( "release_QPlainTextEdit              Object deleted!" ) );
         #if defined( __HB_DEBUG__ )
            hbqt_debug( "  YES release_QPlainTextEdit              %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
         #endif
      }
      else
      {
         HB_TRACE( HB_TR_DEBUG, ( "release_QPlainTextEdit              Object Name Missing!" ) );
         #if defined( __HB_DEBUG__ )
            hbqt_debug( "  NO  release_QPlainTextEdit" );
         #endif
      }
   }
   else
   {
      HB_TRACE( HB_TR_DEBUG, ( "release_QPlainTextEdit              Object Allready deleted!" ) );
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QPlainTextEdit" );
      #endif
   }
}
...
void * gcAllocate_QPlainTextEdit( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QPlainTextEdit              %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
