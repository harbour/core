...
QT_G_FUNC( release_QSlider )
{
   ...
   if( p && p->ph && p->pq )
   {
      ...
      if( ( QString ) m->className() != ( QString ) "QObject" )
      {
         ...
         HB_TRACE( HB_TR_DEBUG, ( "release_QSlider                     Object deleted!" ) );
            ...
            hbqt_debug( "  YES release_QSlider                     %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
         #endif
      }
      else
      {
   ...
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QSlider" );
      #endif
   }
}
...
void * gcAllocate_QSlider( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QSlider                     %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
