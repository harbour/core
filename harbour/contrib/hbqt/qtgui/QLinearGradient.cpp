...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPointF( hbqt_par_QLinearGradient( 1 )->finalStop() ), release_QPointF ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPointF( hbqt_par_QLinearGradient( 1 )->start() ), release_QPointF ) );
}
