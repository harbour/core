...
QT_G_FUNC( release_QLinearGradient )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QLinearGradient             Object deleted!" ) );
         ...
         hbqt_debug( "  YES release_QLinearGradient             %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
      #endif
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QLinearGradient" );
      #endif
   }
}
...
void * gcAllocate_QLinearGradient( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QLinearGradient             %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
