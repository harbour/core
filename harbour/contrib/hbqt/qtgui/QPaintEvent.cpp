...
QT_G_FUNC( hbqt_gcRelease_QPaintEvent )
{
   ...
   HB_TRACE( HB_TR_DEBUG, ( "hbqt_gcRelease_QPaintEvent                  p=%p", p ) );
   HB_TRACE( HB_TR_DEBUG, ( "hbqt_gcRelease_QPaintEvent                 ph=%p", p->ph ) );

   if( p && p->ph )
   {
      delete ( ( QPaintEvent * ) p->ph );
      p->ph = NULL;
      HB_TRACE( HB_TR_DEBUG, ( "YES hbqt_gcRelease_QPaintEvent                 Object deleted! %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() ) );
   }
   else
   {
      HB_TRACE( HB_TR_DEBUG, ( "DEL hbqt_gcRelease_QPaintEvent                 Object Already deleted!" ) );
   }
}
...
void * hbqt_gcAllocate_QPaintEvent( void * pObj )
{
   ...
   HB_TRACE( HB_TR_DEBUG, ( "          new_QPaintEvent                 %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() ) );
   return( p );
}
