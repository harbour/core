...
QT_G_FUNC( release_QTextImageFormat )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QTextImageFormat            Object deleted!" ) );
         ...
         hbqt_debug( "  YES release_QTextImageFormat            %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
      #endif
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QTextImageFormat" );
      #endif
   }
}
...
void * gcAllocate_QTextImageFormat( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QTextImageFormat            %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
