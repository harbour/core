...
QT_G_FUNC( release_QStyleOptionButton )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QStyleOptionButton          Object deleted!" ) );
         ...
         hbqt_debug( "  YES release_QStyleOptionButton          %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
      #endif
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QStyleOptionButton" );
      #endif
   }
}
...
void * gcAllocate_QStyleOptionButton( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QStyleOptionButton          %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
