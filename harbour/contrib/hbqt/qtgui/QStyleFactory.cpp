...
QT_G_FUNC( release_QStyleFactory )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QStyleFactory               Object deleted!" ) );
         ...
         just_debug( "  YES release_QStyleFactory               %i B %i KB", ( int ) hb_xquery( 1001 ), hb_getMemUsed() );
      #endif
   }
   else
   {
      ...
      #if defined(__debug__)
         just_debug( "  DEL release_QStyleFactory" );
      #endif
   }
}
...
void * gcAllocate_QStyleFactory( void * pObj )
{
   ...
   #if defined(__debug__)
      just_debug( "          new_QStyleFactory               %i B %i KB", ( int ) hb_xquery( 1001 ), hb_getMemUsed() );
   #endif
   return( p );
}
