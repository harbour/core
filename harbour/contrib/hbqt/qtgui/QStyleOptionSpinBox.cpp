...
QT_G_FUNC( release_QStyleOptionSpinBox )
{
   ...
   HB_TRACE( HB_TR_DEBUG, ( "release_QStyleOptionSpinBox          p=%p", p ) );
   HB_TRACE( HB_TR_DEBUG, ( "release_QStyleOptionSpinBox         ph=%p", p->ph ) );

   if( p && p->ph )
   {
      ( ( QStyleOptionSpinBox * ) p->ph )->~QStyleOptionSpinBox();
      p->ph = NULL;
      HB_TRACE( HB_TR_DEBUG, ( "release_QStyleOptionSpinBox         Object deleted!" ) );
      #if defined(__debug__)
         just_debug( "  YES release_QStyleOptionSpinBox         %i B %i KB", ( int ) hb_xquery( 1001 ), hb_getMemUsed() );
      #endif
   }
   else
   {
      ...
      #if defined(__debug__)
         just_debug( "  DEL release_QStyleOptionSpinBox" );
      #endif
   }
}
...
void * gcAllocate_QStyleOptionSpinBox( void * pObj )
{
   ...
   #if defined(__debug__)
      just_debug( "          new_QStyleOptionSpinBox         %i B %i KB", ( int ) hb_xquery( 1001 ), hb_getMemUsed() );
   #endif
   return( p );
}
