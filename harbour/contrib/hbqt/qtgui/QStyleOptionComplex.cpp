...
QT_G_FUNC( release_QStyleOptionComplex )
{
   ...
   if( p && p->ph )
   {
      ...
      p->ph = NULL;
      HB_TRACE( HB_TR_DEBUG, ( "YES release_QStyleOptionComplex         Object deleted! %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() ) );
   }
   else
   {
      HB_TRACE( HB_TR_DEBUG, ( "DEL release_QStyleOptionComplex         Object Allready deleted!" ) );
   }
}
...
void * gcAllocate_QStyleOptionComplex( void * pObj )
{
   ...
   HB_TRACE( HB_TR_DEBUG, ( "          new_QStyleOptionComplex         %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() ) );
   return( p );
}
