...
QT_G_FUNC( release_QPrintPreviewDialog )
{
   ...
   if( p && p->ph && p->pq )
   {
      ...
      if( ( QString ) m->className() != ( QString ) "QObject" )
      {
         ...
         HB_TRACE( HB_TR_DEBUG, ( "release_QPrintPreviewDialog         Object deleted!" ) );
            ...
            hbqt_debug( "  YES release_QPrintPreviewDialog         %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
         #endif
      }
      else
      {
         ...
         #if defined( __HB_DEBUG__ )
            hbqt_debug( "  NO  release_QPrintPreviewDialog" );
         #endif
      }
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QPrintPreviewDialog" );
      #endif
   }
}
...
void * gcAllocate_QPrintPreviewDialog( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QPrintPreviewDialog         %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
