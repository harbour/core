...
QT_G_FUNC( release_QTransform )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QTransform                  Object deleted!" ) );
         ...
         just_debug( "  YES release_QTransform                  %i B %i KB", ( int ) hb_xquery( 1001 ), hb_getMemUsed() );
      #endif
   }
   else
   {
      ...
      #if defined(__debug__)
         just_debug( "  DEL release_QTransform" );
      #endif
   }
}
...
void * gcAllocate_QTransform( void * pObj )
{
   ...
   #if defined(__debug__)
      just_debug( "          new_QTransform                  %i B %i KB", ( int ) hb_xquery( 1001 ), hb_getMemUsed() );
   #endif
   return( p );
}
