...
QT_G_FUNC( release_QScrollArea )
{
   ...
   if( p && p->ph && p->pq )
   {
      ...
      if( ( QString ) m->className() != ( QString ) "QObject" )
      {
         ...
         HB_TRACE( HB_TR_DEBUG, ( "release_QScrollArea                 Object deleted!" ) );
            ...
            just_debug( "  YES release_QScrollArea                 %i B %i KB", ( int ) hb_xquery( 1001 ), hb_getMemUsed() );
         #endif
      }
      else
      {
         ...
         #if defined(__debug__)
            just_debug( "  NO  release_QScrollArea" );
         #endif
      }
   }
   else
   {
      ...
      #if defined(__debug__)
         just_debug( "  DEL release_QScrollArea" );
      #endif
   }
}
...
void * gcAllocate_QScrollArea( void * pObj )
{
   ...
   #if defined(__debug__)
      just_debug( "          new_QScrollArea                 %i B %i KB", ( int ) hb_xquery( 1001 ), hb_getMemUsed() );
   #endif
   return( p );
}
