...
QT_G_FUNC( release_QTabBar )
{
   ...
   if( p && p->ph && p->pq )
   {
      ...
      if( ( QString ) m->className() != ( QString ) "QObject" )
      {
         ...
         HB_TRACE( HB_TR_DEBUG, ( "release_QTabBar                     Object deleted!" ) );
            ...
            hbqt_debug( "  YES release_QTabBar                     %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
         #endif
      }
      else
      {
   ...
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QTabBar" );
      #endif
   }
}
...
void * gcAllocate_QTabBar( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QTabBar                     %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
