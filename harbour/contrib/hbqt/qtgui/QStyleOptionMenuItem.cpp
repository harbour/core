...
QT_G_FUNC( hbqt_gcRelease_QStyleOptionMenuItem )
{
   ...
   HB_TRACE( HB_TR_DEBUG, ( "hbqt_gcRelease_QStyleOptionMenuItem         p=%p", p ) );
   HB_TRACE( HB_TR_DEBUG, ( "hbqt_gcRelease_QStyleOptionMenuItem        ph=%p", p->ph ) );

   if( p && p->ph )
   {
      delete ( ( QStyleOptionMenuItem * ) p->ph );
      p->ph = NULL;
      HB_TRACE( HB_TR_DEBUG, ( "YES hbqt_gcRelease_QStyleOptionMenuItem        Object deleted! %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() ) );
   }
   else
   {
      HB_TRACE( HB_TR_DEBUG, ( "DEL hbqt_gcRelease_QStyleOptionMenuItem        Object Already deleted!" ) );
   }
}

void * hbqt_gcAllocate_QStyleOptionMenuItem( void * pObj )
{
...
{
   hb_retptrGC( hbqt_gcAllocate_QFont( new QFont( hbqt_par_QStyleOptionMenuItem( 1 )->font ) ) );
}
...
{
   hb_retptrGC( hbqt_gcAllocate_QIcon( new QIcon( hbqt_par_QStyleOptionMenuItem( 1 )->icon ) ) );
}
...
{
   hb_retptrGC( hbqt_gcAllocate_QRect( new QRect( hbqt_par_QStyleOptionMenuItem( 1 )->menuRect ) ) );
}
