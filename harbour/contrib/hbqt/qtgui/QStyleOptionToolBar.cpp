...
QT_G_FUNC( release_QStyleOptionToolBar )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QStyleOptionToolBar         Object deleted!" ) );
         ...
         hbqt_debug( "  YES release_QStyleOptionToolBar         %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
      #endif
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QStyleOptionToolBar" );
      #endif
   }
}
...
void * gcAllocate_QStyleOptionToolBar( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QStyleOptionToolBar         %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
