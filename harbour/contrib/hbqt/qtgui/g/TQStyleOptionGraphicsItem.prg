...
CREATE CLASS QStyleOptionGraphicsItem INHERIT HbQtObjectHandler, QStyleOption
...
METHOD QStyleOptionGraphicsItem:exposedRect()
   RETURN Qt_QStyleOptionGraphicsItem_exposedRect( ::pPtr )
...
METHOD QStyleOptionGraphicsItem:matrix()
   RETURN Qt_QStyleOptionGraphicsItem_matrix( ::pPtr )
