...
METHOD QGraphicsProxyWidget:createProxyForChildWidget( pChild )
   RETURN Qt_QGraphicsProxyWidget_createProxyForChildWidget( ::pPtr, hbqt_ptr( pChild ) )
...
METHOD QGraphicsProxyWidget:subWidgetRect( pWidget )
   RETURN Qt_QGraphicsProxyWidget_subWidgetRect( ::pPtr, hbqt_ptr( pWidget ) )


METHOD QGraphicsProxyWidget:widget()
   RETURN Qt_QGraphicsProxyWidget_widget( ::pPtr )
