...
METHOD QGraphicsItemAnimation:item()
   RETURN Qt_QGraphicsItemAnimation_item( ::pPtr )


METHOD QGraphicsItemAnimation:matrixAt( nStep )
   RETURN Qt_QGraphicsItemAnimation_matrixAt( ::pPtr, nStep )


METHOD QGraphicsItemAnimation:posAt( nStep )
   RETURN Qt_QGraphicsItemAnimation_posAt( ::pPtr, nStep )
...
METHOD QGraphicsItemAnimation:timeLine()
   RETURN Qt_QGraphicsItemAnimation_timeLine( ::pPtr )
