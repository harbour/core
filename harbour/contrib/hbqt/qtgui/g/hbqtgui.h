...
#define HBQT_TYPE_QDragEnterEvent                               ( HBQT_TYPE_QTGUI_BASE + 44 )
#define HBQT_TYPE_QDragLeaveEvent                               ( HBQT_TYPE_QTGUI_BASE + 45 )
#define HBQT_TYPE_QDragMoveEvent                                ( HBQT_TYPE_QTGUI_BASE + 46 )
#define HBQT_TYPE_QDropEvent                                    ( HBQT_TYPE_QTGUI_BASE + 47 )
#define HBQT_TYPE_QErrorMessage                                 ( HBQT_TYPE_QTGUI_BASE + 48 )
#define HBQT_TYPE_QFileDialog                                   ( HBQT_TYPE_QTGUI_BASE + 49 )
#define HBQT_TYPE_QFileIconProvider                             ( HBQT_TYPE_QTGUI_BASE + 50 )
#define HBQT_TYPE_QFileSystemModel                              ( HBQT_TYPE_QTGUI_BASE + 51 )
#define HBQT_TYPE_QFocusEvent                                   ( HBQT_TYPE_QTGUI_BASE + 52 )
#define HBQT_TYPE_QFocusFrame                                   ( HBQT_TYPE_QTGUI_BASE + 53 )
#define HBQT_TYPE_QFont                                         ( HBQT_TYPE_QTGUI_BASE + 54 )
#define HBQT_TYPE_QFontComboBox                                 ( HBQT_TYPE_QTGUI_BASE + 55 )
#define HBQT_TYPE_QFontDatabase                                 ( HBQT_TYPE_QTGUI_BASE + 56 )
#define HBQT_TYPE_QFontDialog                                   ( HBQT_TYPE_QTGUI_BASE + 57 )
#define HBQT_TYPE_QFontInfo                                     ( HBQT_TYPE_QTGUI_BASE + 58 )
#define HBQT_TYPE_QFontMetrics                                  ( HBQT_TYPE_QTGUI_BASE + 59 )
#define HBQT_TYPE_QFontMetricsF                                 ( HBQT_TYPE_QTGUI_BASE + 60 )
#define HBQT_TYPE_QFormLayout                                   ( HBQT_TYPE_QTGUI_BASE + 61 )
#define HBQT_TYPE_QFrame                                        ( HBQT_TYPE_QTGUI_BASE + 62 )
#define HBQT_TYPE_QGradient                                     ( HBQT_TYPE_QTGUI_BASE + 63 )
#define HBQT_TYPE_QGraphicsEllipseItem                          ( HBQT_TYPE_QTGUI_BASE + 64 )
#define HBQT_TYPE_QGraphicsGridLayout                           ( HBQT_TYPE_QTGUI_BASE + 65 )
#define HBQT_TYPE_QGraphicsItem                                 ( HBQT_TYPE_QTGUI_BASE + 66 )
#define HBQT_TYPE_QGraphicsItemAnimation                        ( HBQT_TYPE_QTGUI_BASE + 67 )
#define HBQT_TYPE_QGraphicsItemGroup                            ( HBQT_TYPE_QTGUI_BASE + 68 )
#define HBQT_TYPE_QGraphicsLayout                               ( HBQT_TYPE_QTGUI_BASE + 69 )
#define HBQT_TYPE_QGraphicsLayoutItem                           ( HBQT_TYPE_QTGUI_BASE + 70 )
#define HBQT_TYPE_QGraphicsLinearLayout                         ( HBQT_TYPE_QTGUI_BASE + 71 )
#define HBQT_TYPE_QGraphicsLineItem                             ( HBQT_TYPE_QTGUI_BASE + 72 )
#define HBQT_TYPE_QGraphicsPathItem                             ( HBQT_TYPE_QTGUI_BASE + 73 )
#define HBQT_TYPE_QGraphicsPixmapItem                           ( HBQT_TYPE_QTGUI_BASE + 74 )
#define HBQT_TYPE_QGraphicsPolygonItem                          ( HBQT_TYPE_QTGUI_BASE + 75 )
