...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QRectF( hbqt_par_QPainterPath( 1 )->boundingRect() ), release_QRectF ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QRectF( hbqt_par_QPainterPath( 1 )->controlPointRect() ), release_QRectF ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPointF( hbqt_par_QPainterPath( 1 )->currentPosition() ), release_QPointF ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPainterPath( hbqt_par_QPainterPath( 1 )->intersected( *hbqt_par_QPainterPath( 2 ) ) ), release_QPainterPath ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPointF( hbqt_par_QPainterPath( 1 )->pointAtPercent( hb_parnd( 2 ) ) ), release_QPointF ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPainterPath( hbqt_par_QPainterPath( 1 )->simplified() ), release_QPainterPath ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPainterPath( hbqt_par_QPainterPath( 1 )->subtracted( *hbqt_par_QPainterPath( 2 ) ) ), release_QPainterPath ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPolygonF( hbqt_par_QPainterPath( 1 )->toFillPolygon( *hbqt_par_QTransform( 2 ) ) ), release_QPolygonF ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPolygonF( hbqt_par_QPainterPath( 1 )->toFillPolygon( ( HB_ISPOINTER( 2 ) ? *hbqt_par_QMatrix( 2 ) : QMatrix() ) ) ), release_QPolygonF ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPainterPath( hbqt_par_QPainterPath( 1 )->toReversed() ), release_QPainterPath ) );
}
...
{
   hb_retptrGC( hbqt_ptrTOgcpointer( new QPainterPath( hbqt_par_QPainterPath( 1 )->united( *hbqt_par_QPainterPath( 2 ) ) ), release_QPainterPath ) );
}
