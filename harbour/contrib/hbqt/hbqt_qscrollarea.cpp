...
{
   hb_retni( hbqt_par_QScrollArea( 1 )->alignment(  ) );
}
...
{
   hbqt_par_QScrollArea( 1 )->ensureVisible( hb_parni( 2 ), hb_parni( 3 ), hb_parni( 4 ), hb_parni( 5 ) );
}
...
{
   hbqt_par_QScrollArea( 1 )->ensureWidgetVisible( hbqt_par_QWidget( 2 ), hb_parni( 3 ), hb_parni( 4 ) );
}
