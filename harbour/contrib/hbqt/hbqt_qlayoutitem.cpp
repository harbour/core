...
{
   hb_retni( hbqt_par_QLayoutItem( 1 )->expandingDirections(  ) );
}
...
{
   hbqt_ret_QRect( hbqt_par_QLayoutItem( 1 )->geometry(  ) );
}
...
{
   hbqt_ret_QSize( hbqt_par_QLayoutItem( 1 )->maximumSize(  ) );
}
...
{
   hbqt_ret_QSize( hbqt_par_QLayoutItem( 1 )->minimumSize(  ) );
}
...
{
   hbqt_par_QLayoutItem( 1 )->setGeometry( hbqt_const_QRect( 2 ) );
}
...
{
   hbqt_ret_QSize( hbqt_par_QLayoutItem( 1 )->sizeHint(  ) );
}
