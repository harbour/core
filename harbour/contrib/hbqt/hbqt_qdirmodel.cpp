...
{
   hb_retni( hbqt_par_QDirModel( 1 )->columnCount( *hbqt_par_QModelIndex( 2 ) ) );
}
...
{
   hb_retl( hbqt_par_QDirModel( 1 )->hasChildren( *hbqt_par_QModelIndex( 2 ) ) );
}
...
{
   hb_retptr( new QModelIndex( hbqt_par_QDirModel( 1 )->index( hb_parni( 2 ), hb_parni( 3 ), *hbqt_par_QModelIndex( 4 ) ) ) );
}
...
{
   hb_retni( hbqt_par_QDirModel( 1 )->rowCount( *hbqt_par_QModelIndex( 2 ) ) );
}
...
{
   hbqt_par_QDirModel( 1 )->refresh( *hbqt_par_QModelIndex( 2 ) );
}
