...
HB_CALL_ON_STARTUP_BEGIN( _hbqtopengl_init_ )
   hb_vmAtInit( hbqt_lib_init, NULL );
   hb_vmAtExit( hbqt_lib_exit, NULL );
HB_CALL_ON_STARTUP_END( _hbqtopengl_init_ )

#if defined( HB_PRAGMA_STARTUP )
   #pragma startup _hbqtopengl_init_ 
#elif defined( HB_DATASEG_STARTUP )
   #define HB_DATASEG_BODY    HB_DATASEG_FUNC( _hbqtopengl_init_ )
   #include "hbiniseg.h"
#endif
