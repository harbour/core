...
QT_G_FUNC( release_QHttpResponseHeader )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QHttpResponseHeader         Object deleted!" ) );
         ...
         hbqt_debug( "  YES release_QHttpResponseHeader         %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
      #endif
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QHttpResponseHeader" );
      #endif
   }
}
...
void * gcAllocate_QHttpResponseHeader( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QHttpResponseHeader         %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
