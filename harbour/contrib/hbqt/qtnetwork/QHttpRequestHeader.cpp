...
QT_G_FUNC( release_QHttpRequestHeader )
{
   ...
   if( p && p->ph )
   {
      ...
      HB_TRACE( HB_TR_DEBUG, ( "release_QHttpRequestHeader          Object deleted!" ) );
         ...
         hbqt_debug( "  YES release_QHttpRequestHeader          %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
      #endif
   }
   else
   {
      ...
      #if defined( __HB_DEBUG__ )
         hbqt_debug( "  DEL release_QHttpRequestHeader" );
      #endif
   }
}
...
void * gcAllocate_QHttpRequestHeader( void * pObj )
{
   ...
   #if defined( __HB_DEBUG__ )
      hbqt_debug( "          new_QHttpRequestHeader          %i B %i KB", ( int ) hb_xquery( 1001 ), hbqt_getmemused() );
   #endif
   return( p );
}
