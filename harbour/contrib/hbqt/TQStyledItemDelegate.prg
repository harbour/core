...
CREATE CLASS QStyledItemDelegate
   ...
   METHOD  itemEditorFactory()                 INLINE  Qt_QStyledItemDelegate_itemEditorFactory( ::pPtr )
   ...
   METHOD  setItemEditorFactory( pFactory )    INLINE  Qt_QStyledItemDelegate_setItemEditorFactory( ::pPtr, pFactory )
