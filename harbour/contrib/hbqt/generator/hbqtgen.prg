...
STATIC FUNCTION Build_HBQT_SLOTS_CPP( cPathOut )
   ...
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExec( widget, ( QString ) "hovered()", NULL );                                                                                     ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
...
STATIC FUNCTION Build_MOC_SLOTS_CPP( cPathOut )
   ...
   aadd( txt_, '**                                                                                              ' )
   aadd( txt_, '** Created: Thu Jun 11 00:20:48 2009                                                            ' )
   ...
   aadd( txt_, '    "mouseMoveEvent(QMouseEvent*)\0"                                                            ' )
   aadd( txt_, '};                                                                                              ' )
   aadd( txt_, '                                                                                                ' )
