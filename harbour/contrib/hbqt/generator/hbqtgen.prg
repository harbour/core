...
STATIC FUNCTION Build_HBQT_SLOTS_CPP( cPathOut )
   ...
   aadd( txt_, '   {                                                                                                                                                     ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( activated( int ) )   , s, SLOT( activated( int ) )   , Qt::AutoConnection );                                ' )
   aadd( txt_, '   }                                                                                                                                                     ' )
   aadd( txt_, '   if( signal == ( QString ) "currentIndexChanged(int)" )                                                                                                ' )
   aadd( txt_, '   {                                                                                                                                                     ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( currentIndexChanged( int ) ), s, SLOT( currentIndexChanged( int ) ), Qt::AutoConnection );                  ' )
   aadd( txt_, '   }                                                                                                                                                     ' )
   aadd( txt_, '   if( signal == ( QString ) "highlighted(int)" )                                                                                                        ' )
   aadd( txt_, '   {                                                                                                                                                     ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( highlighted( int ) ) , s, SLOT( highlighted( int ) ) , Qt::AutoConnection );                                ' )
   aadd( txt_, '   }                                                                                                                                                     ' )
   ...
   aadd( txt_, '   {                                                                                                                                                     ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( clicked_model( const QModelIndex & ) ), s, SLOT( clicked( const QModelIndex & ) ) , Qt::AutoConnection );   ' )
   aadd( txt_, '   }                                                                                                                                                     ' )
   aadd( txt_, '                                                                                                                                                         ' )
...
STATIC FUNCTION Build_MOC_SLOTS_CPP( cPathOut )
   ...
   aadd( txt_, '**                                                                                             ' )
   aadd( txt_, '** Created: Sun Jun 7 21:29:21 2009                                                            ' )
