...
STATIC FUNCTION Build_InBuilds( cPOut )
...
STATIC FUNCTION Build_HBQT_H( cPathOut )
   ...
   aadd( txt_, "#define hbqt_par_QAbstractTableModel( n )    ( ( QAbstractTableModel* ) hb_parptr( n ) )      " )
   aadd( txt_, "#define hbqt_par_QFileSystemModel( n )       ( ( QFileSystemModel* ) hb_parptr( n ) )         " )
   aadd( txt_, "#define hbqt_par_QKeyEvent( n )              ( ( QKeyEvent* ) hb_parptr( n ) )                " )
   aadd( txt_, "#define hbqt_par_QMouseEvent( n )            ( ( QMouseEvent* ) hb_parptr( n ) )              " )
   aadd( txt_, "#define hbqt_par_QKeySequence( n )           ( ( QKeySequence* ) hb_parptr( n ) )             " )
   aadd( txt_, "                                                                                              " )
...
STATIC FUNCTION Build_HBQT_SLOTS_H( cPathOut )
   ...
   aadd( txt_, '#include <QMainWindow>                               ' )
   aadd( txt_, '#include <QList>                                     ' )
   aadd( txt_, '#include <QModelIndex>                               ' )
   aadd( txt_, '#include <QEvent>                                    ' )
   aadd( txt_, '#include <QKeyEvent>                                 ' )
   aadd( txt_, '#include <QMouseEvent>                               ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '#include "hbapi.h"                                   ' )
   aadd( txt_, '#include "hbapiitm.h"                                ' )
   ...
   aadd( txt_, '   void activated( int index );                      ' )
   aadd( txt_, '   void currentIndexChanged( int index );            ' )
   aadd( txt_, '   void highlighted( int index );                    ' )
   aadd( txt_, '   void returnPressed();                             ' )
   aadd( txt_, '   void clicked( const QModelIndex & index );        ' )
   aadd( txt_, '   void doubleClicked( const QModelIndex & index );  ' )
   aadd( txt_, '   void entered( const QModelIndex & index );        ' )
   aadd( txt_, '   void viewportEntered();                           ' )
   aadd( txt_, '   bool event( QEvent * event );                     ' )
   aadd( txt_, '   void keyPressEvent( QKeyEvent * event );          ' )
   aadd( txt_, '   void mouseMoveEvent( QMouseEvent * event );       ' )
   aadd( txt_, '   void hovered( QAction * action );                 ' )
   aadd( txt_, '   void currentChanged( int index );                 ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '#if 0                                                ' )
   aadd( txt_, '   void accessibleEvent();                           ' )
   aadd( txt_, '   void actionEvent();                               ' )
   aadd( txt_, '   void childEvent();                                ' )
   aadd( txt_, '   void closeEvent();                                ' )
   aadd( txt_, '   void customEvent();                               ' )
   aadd( txt_, '   void dragLeaveEvent();                            ' )
   aadd( txt_, '   void dropEvent();                                 ' )
   aadd( txt_, '   void dynamicPropertyChangeEvent();                ' )
   aadd( txt_, '   void fileOpenEvent();                             ' )
   aadd( txt_, '   void focusEvent();                                ' )
   aadd( txt_, '   void graphicsSceneEvent();                        ' )
   aadd( txt_, '   void helpEvent();                                 ' )
   aadd( txt_, '   void hideEvent();                                 ' )
   aadd( txt_, '   void hoverEvent();                                ' )
   aadd( txt_, '   void iconDragEvent();                             ' )
   aadd( txt_, '   void inputEvent();                                ' )
   aadd( txt_, '   void inputMethodEvent();                          ' )
   aadd( txt_, '   void moveEvent();                                 ' )
   aadd( txt_, '   void paintEvent();                                ' )
   aadd( txt_, '   void resizeEvent();                               ' )
   aadd( txt_, '   void shortcutEvent();                             ' )
   aadd( txt_, '   void showEvent();                                 ' )
   aadd( txt_, '   void statusTipEvent();                            ' )
   aadd( txt_, '   void timerEvent();                                ' )
   aadd( txt_, '   void whatsThisClickedEvent();                     ' )
   aadd( txt_, '   void windowStateChangeEvent();                    ' )
   aadd( txt_, '#endif                                               ' )
   aadd( txt_, '};                                                   ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, 'class MyDrawingArea : public QWidget                 ' )
   aadd( txt_, '{                                                    ' )
   aadd( txt_, '   Q_OBJECT                                          ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, 'public:                                              ' )
   aadd( txt_, '   MyDrawingArea( QWidget *parent = 0 );             ' )
   aadd( txt_, '   virtual ~MyDrawingArea( void );                   ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '   #if 0                                             ' )
   aadd( txt_, 'protected slots:                                     ' )
   aadd( txt_, '   void keyReleaseEvent( QKeyEvent * event );        ' )
   aadd( txt_, '   void mousePressEvent( QMouseEvent * event );      ' )
   ...
   aadd( txt_, '   void resizeEvent( QResizeEvent * event );         ' )
   aadd( txt_, '   void wheelEvent( QWheelEvent * event );           ' )
   aadd( txt_, '   void timerEvent( QTimerEvent * event );           ' )
   aadd( txt_, '   void focusInEvent( QFocusEvent * event );         ' )
   aadd( txt_, '   void focusOutEvent( QFocusEvent * event );        ' )
   aadd( txt_, '   void moveEvent( QMoveEvent * event );             ' )
   aadd( txt_, '   bool event( QEvent * event );                     ' )
   aadd( txt_, '   #endif                                            ' )
   aadd( txt_, '   void keyPressEvent( QKeyEvent * event );          ' )
   aadd( txt_, '   void mouseMoveEvent( QMouseEvent * event );       ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, 'signals:                                             ' )
   aadd( txt_, '   void sg_mouseMoveEvent( QMouseEvent * event );    ' )
   aadd( txt_, '   void sg_keyPressEvent( QKeyEvent * event );       ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '};                                                   ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, 'class MyMainWindow : public QMainWindow              ' )
   aadd( txt_, '{                                                    ' )
   aadd( txt_, '    Q_OBJECT                                         ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, 'public:                                              ' )
   aadd( txt_, '    MyMainWindow();                                  ' )
   aadd( txt_, '    virtual ~MyMainWindow();                         ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, 'public:                                              ' )
   aadd( txt_, '    void closeEvent( QCloseEvent *event );           ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '};                                                   ' )
   aadd( txt_, '                                                     ' )
   aadd( txt_, '#endif                                               ' )
...
STATIC FUNCTION Build_HBQT_SLOTS_CPP( cPathOut )
   ...
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'static void SlotsExecAction( QAction* widget, QString event, PHB_ITEM pItem )                                                              ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   for( int i = 0; i < s->list1.size(); ++i )                                                                                              ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      if( ( QAction* ) s->list5.at( i ) == widget )                                                                                        ' )
   aadd( txt_, '      {                                                                                                                                    ' )
   aadd( txt_, '        if( ( ( QString ) s->list2.at( i ) == event ) && ( ( bool ) s->list4.at( i ) == true ) )                                           ' )
   aadd( txt_, '        {                                                                                                                                  ' )
   aadd( txt_, '           PHB_ITEM pWidget = hb_itemPutPtr( NULL, ( QAction* ) widget );                                                                  ' )
   aadd( txt_, '           hb_vmEvalBlockV( ( PHB_ITEM ) s->list3.at( i ), 1, pWidget );                                                                   ' )
   aadd( txt_, '           hb_itemRelease( pWidget );                                                                                                      ' )
   aadd( txt_, '        }                                                                                                                                  ' )
   aadd( txt_, '      }                                                                                                                                    ' )
   ...
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'static void SlotsExecInt( QWidget* widget, QString event, PHB_ITEM pItem, int iValue )                                                     ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   for( int i = 0; i < s->list1.size(); ++i )                                                                                              ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      if( ( QWidget* ) s->list1.at( i ) == widget )                                                                                        ' )
   ...
   aadd( txt_, '         {                                                                                                                                 ' )
   aadd( txt_, '            PHB_ITEM pWidget = hb_itemPutPtr( NULL, ( QWidget* ) widget );                                                                 ' )
   aadd( txt_, '            PHB_ITEM pState = hb_itemPutNI( NULL, iValue );                                                                                ' )
   aadd( txt_, '            hb_vmEvalBlockV( ( PHB_ITEM ) s->list3.at( i ), 2, pWidget, pState );                                                          ' )
   aadd( txt_, '            hb_itemRelease( pWidget );                                                                                                     ' )
   ...
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'static void SlotsExecModel( QWidget* widget, QString event, PHB_ITEM pItem, const QModelIndex & index )                                    ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   for( int i = 0; i < s->list1.size(); ++i )                                                                                              ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      if( ( QWidget* ) s->list1.at( i ) == widget )                                                                                        ' )
   ...
   aadd( txt_, '         {                                                                                                                                 ' )
   aadd( txt_, '            PHB_ITEM pWidget = hb_itemPutPtr( NULL, ( QWidget* ) widget );                                                                 ' )
   aadd( txt_, '            PHB_ITEM pState = hb_itemPutPtr( NULL, ( QModelIndex * ) new QModelIndex( index ) );                                           ' )
   aadd( txt_, '            hb_vmEvalBlockV( ( PHB_ITEM ) s->list3.at( i ), 2, pWidget, pState );                                                          ' )
   aadd( txt_, '            hb_itemRelease( pWidget );                                                                                                     ' )
   aadd( txt_, '            hb_itemRelease( pState );                                                                                                      ' )
   aadd( txt_, '         }                                                                                                                                 ' )
   ...
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'bool Slots::event( QEvent * event )                                                                                                        ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   bool bAccepted = true;                                                                                                                  ' )
   ...
   aadd( txt_, '      {                                                                                                                                    ' )
   aadd( txt_, '         if( ( ( QString ) list2.at( i ) == ( QString ) "event()" ) && ( ( bool ) list4.at( i ) == true ) )                                ' )
   aadd( txt_, '         {                                                                                                                                 ' )
   aadd( txt_, '            PHB_ITEM pWidget  = hb_itemPutPtr( NULL, ( QWidget * ) widget );                                                               ' )
   aadd( txt_, '            PHB_ITEM pEvent   = hb_itemPutPtr( NULL, event );                                                                              ' )
   aadd( txt_, '            bAccepted = hb_vmEvalBlockV( ( PHB_ITEM ) list3.at( i ), 2, pWidget, pEvent );                                                 ' )
   aadd( txt_, '            hb_itemRelease( pWidget );                                                                                                     ' )
   aadd( txt_, '            hb_itemRelease( pEvent );                                                                                                      ' )
   aadd( txt_, '         }                                                                                                                                 ' )
   aadd( txt_, '      }                                                                                                                                    ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   return bAccepted;                                                                                                                       ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::keyPressEvent( QKeyEvent * event )                                                                                             ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QObject *widget = qobject_cast<QObject *>( sender() );                                                                                  ' )
   aadd( txt_, '   for( int i = 0; i < list1.size(); ++i )                                                                                                 ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      if( ( QObject* ) list1.at( i ) == ( QObject* ) widget )                                                                              ' )
   aadd( txt_, '      {                                                                                                                                    ' )
   aadd( txt_, '         if( ( ( QString ) list2.at( i ) == ( QString ) "keyPressEvent()" ) && ( ( bool ) list4.at( i ) == true ) )                        ' )
   aadd( txt_, '         {                                                                                                                                 ' )
   aadd( txt_, '            PHB_ITEM pWidget  = hb_itemPutPtr( NULL, ( QWidget * ) widget );                                                               ' )
   aadd( txt_, '            PHB_ITEM pEvent   = hb_itemPutPtr( NULL, event );                                                                              ' )
   aadd( txt_, '            hb_vmEvalBlockV( ( PHB_ITEM ) list3.at( i ), 2, pWidget, pEvent );                                                             ' )
   aadd( txt_, '            hb_itemRelease( pWidget );                                                                                                     ' )
   aadd( txt_, '            hb_itemRelease( pEvent );                                                                                                      ' )
   aadd( txt_, '         }                                                                                                                                 ' )
   aadd( txt_, '      }                                                                                                                                    ' )
   ...
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::mouseMoveEvent( QMouseEvent * event )                                                                                          ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QObject *widget = qobject_cast<QObject *>( sender() );                                                                                  ' )
   aadd( txt_, '   for( int i = 0; i < list1.size(); ++i )                                                                                                 ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      if( ( QObject* ) list1.at( i ) == ( QObject* ) widget )                                                                              ' )
   aadd( txt_, '      {                                                                                                                                    ' )
   aadd( txt_, '         if( ( ( QString ) list2.at( i ) == ( QString ) "mouseMoveEvent()" ) && ( ( bool ) list4.at( i ) == true ) )                       ' )
   aadd( txt_, '         {                                                                                                                                 ' )
   aadd( txt_, '            PHB_ITEM pWidget  = hb_itemPutPtr( NULL, ( QWidget * ) widget );                                                               ' )
   aadd( txt_, '            PHB_ITEM pEvent   = hb_itemPutPtr( NULL, event );                                                                              ' )
   aadd( txt_, '            hb_vmEvalBlockV( ( PHB_ITEM ) list3.at( i ), 2, pWidget, pEvent );                                                             ' )
   ...
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::hovered( QAction * action )                                                                                                    ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QObject *widget = qobject_cast<QObject *>( sender() );                                                                                  ' )
   aadd( txt_, '   for( int i = 0; i < list1.size(); ++i )                                                                                                 ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      if( ( QObject* ) list1.at( i ) == ( QObject* ) widget )                                                                              ' )
   aadd( txt_, '      {                                                                                                                                    ' )
   aadd( txt_, '         if( ( ( QString ) list2.at( i ) == ( QString ) "hovered(action)" ) && ( ( bool ) list4.at( i ) == true ) )                        ' )
   aadd( txt_, '         {                                                                                                                                 ' )
   aadd( txt_, '            PHB_ITEM pWidget  = hb_itemPutPtr( NULL, ( QWidget * ) widget );                                                               ' )
   aadd( txt_, '            PHB_ITEM pEvent   = hb_itemPutPtr( NULL, action );                                                                             ' )
   aadd( txt_, '            hb_vmEvalBlockV( ( PHB_ITEM ) list3.at( i ), 2, pWidget, pEvent );                                                             ' )
   aadd( txt_, '            hb_itemRelease( pWidget );                                                                                                     ' )
   aadd( txt_, '            hb_itemRelease( pEvent );                                                                                                      ' )
   aadd( txt_, '         }                                                                                                                                 ' )
   ...
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::returnPressed()                                                                                                                ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExec( widget, ( QString ) "returnPressed()", NULL );                                                                               ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::viewportEntered()                                                                                                              ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExec( widget, ( QString ) "viewportEntered()", NULL );                                                                             ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::pressed()                                                                                                                      ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExec( widget, ( QString ) "pressed()", NULL );                                                                                     ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::released()                                                                                                                     ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExec( widget, ( QString ) "released()", NULL );                                                                                    ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::hovered()                                                                                                                      ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   //QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                ' )
   aadd( txt_, '   QAction *widget = qobject_cast<QAction *>( sender() );                                                                                  ' )
   aadd( txt_, '   if( widget )                                                                                                                            ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      SlotsExecAction( widget, ( QString ) "hovered()", NULL );                                                                            ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   ...
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExec( widget, ( QString ) "triggered()", NULL );                                                                                   ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   ...
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExecInt( widget, ( QString ) "stateChanged(int)", NULL, state );                                                                   ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::activated( int index )                                                                                                         ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExecInt( widget, ( QString ) "activated(int)", NULL, index );                                                                      ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::currentIndexChanged( int index )                                                                                               ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExecInt( widget, ( QString ) "currentIndexChanged(int)", NULL, index );                                                            ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::currentChanged( int index )                                                                                                    ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExecInt( widget, ( QString ) "currentChanged(int)", NULL, index );                                                                 ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::highlighted( int index )                                                                                                       ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget *widget = qobject_cast<QWidget *>( sender() );                                                                                  ' )
   aadd( txt_, '   SlotsExecInt( widget, ( QString ) "highlighted(int)", NULL, index );                                                                    ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::clicked( const QModelIndex & index )                                                                                           ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget * widget = qobject_cast<QWidget *>( sender() );                                                                                 ' )
   aadd( txt_, '   SlotsExecModel( widget, ( QString ) "clicked(QModelIndex)", NULL, index );                                                              ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, 'void Slots::doubleClicked( const QModelIndex & index )                                                                                     ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget * widget = qobject_cast<QWidget *>( sender() );                                                                                 ' )
   aadd( txt_, '   SlotsExecModel( widget, ( QString ) "doubleClicked(QModelIndex)", NULL, index );                                                        ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, 'void Slots::entered( const QModelIndex & index )                                                                                           ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget * widget = qobject_cast<QWidget *>( sender() );                                                                                 ' )
   aadd( txt_, '   SlotsExecModel( widget, ( QString ) "entered(QModelIndex)", NULL, index );                                                              ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, '/*                                                                                                                                         ' )
   ...
   aadd( txt_, '    */                                                                                                                                     ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, '   /*                    Events with no parameters                  */                                                                     ' )
   aadd( txt_, '   if( signal == ( QString ) "clicked()" )                                                                                                 ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( clicked() )          , s, SLOT( clicked() )          , Qt::AutoConnection );                  ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "returnPressed()" )                                                                                           ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( returnPressed() )    , s, SLOT( returnPressed() )    , Qt::AutoConnection );                  ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   ...
   aadd( txt_, '      bAct = true;                                                                                                                         ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "viewportEntered()" )                                                                                         ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( viewportEntered() )  , s, SLOT( viewportEntered() ) , Qt::AutoConnection );                   ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   ...
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( released() )         ,                                                                        ' )
   aadd( txt_, '                             s, SLOT( released() ), Qt::AutoConnection );                                                                  ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   /*                   Events with int parameter                 */                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "stateChanged(int)" )                                                                                         ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( stateChanged( int ) ),                                                                        ' )
   aadd( txt_, '                             s, SLOT( stateChanged( int ) ), Qt::AutoConnection );                                                         ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "activated(int)" )                                                                                            ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( activated( int ) ),                                                                           ' )
   aadd( txt_, '                             s, SLOT( activated( int ) )   , Qt::AutoConnection );                                                         ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "currentIndexChanged(int)" )                                                                                  ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( currentIndexChanged( int ) ),                                                                 ' )
   aadd( txt_, '                             s, SLOT( currentIndexChanged( int ) ), Qt::AutoConnection );                                                  ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "highlighted(int)" )                                                                                          ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( highlighted( int ) ) ,                                                                        ' )
   aadd( txt_, '                             s, SLOT( highlighted( int ) ) , Qt::AutoConnection );                                                         ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   /*                    Events with bool parameter               */                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "triggered(bool)" )                                                                                           ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( triggered( bool ) ),                                                                          ' )
   aadd( txt_, '                             s, SLOT( triggered( bool ) )  , Qt::AutoConnection );                                                         ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   /*                    Events with miscellaneous parameters     */                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "clicked(QModelIndex)" )                                                                                      ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( clicked( const QModelIndex & ) ),                                                             ' )
   aadd( txt_, '                             s, SLOT( clicked( const QModelIndex & ) ), Qt::AutoConnection );                                              ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "doubleClicked(QModelIndex)" )                                                                                ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( doubleClicked( const QModelIndex & ) ),                                                       ' )
   aadd( txt_, '                             s, SLOT( doubleClicked( const QModelIndex & ) ), Qt::AutoConnection );                                        ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "entered(QModelIndex)" )                                                                                      ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( entered( const QModelIndex & ) ),                                                             ' )
   aadd( txt_, '                             s, SLOT( entered( const QModelIndex & ) ), Qt::AutoConnection );                                              ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "event()" )                                                                                                   ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( event( QEvent * ) ),                                                                          ' )
   aadd( txt_, '                             s, SLOT( event( QEvent * ) ) , Qt::AutoConnection );                                                          ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "keyPressEvent()" )                                                                                           ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( sg_keyPressEvent( QKeyEvent * ) ),                                                            ' )
   aadd( txt_, '                             s, SLOT( keyPressEvent( QKeyEvent * ) ), Qt::AutoConnection );                                                ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "mouseMoveEvent()" )                                                                                          ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( sg_mouseMoveEvent( QMouseEvent * ) ),                                                         ' )
   aadd( txt_, '                             s, SLOT( mouseMoveEvent( QMouseEvent * ) ), Qt::AutoConnection );                                             ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "hovered(action)" )                                                                                           ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( hovered( QAction * ) ),                                                                       ' )
   aadd( txt_, '                             s, SLOT( hovered( QAction * ) ), Qt::AutoConnection );                                                        ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '   if( signal == ( QString ) "currentChanged(int)" )                                                                                       ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( currentChanged( int ) ),                                                                      ' )
   aadd( txt_, '                             s, SLOT( currentChanged( int ) ), Qt::AutoConnection );                                                       ' )
   aadd( txt_, '   }                                                                                                                                       ' )
   aadd( txt_, '                                                                                                                                           ' )
   ...
   aadd( txt_, '      if( bAct )                                                                                                                           ' )
   aadd( txt_, '      {                                                                                                                                    ' )
   aadd( txt_, '         s->list5 << ( QAction* ) hb_parptr( 1 );                                                                                          ' )
   aadd( txt_, '         s->list1 << NULL;                                                                                                                 ' )
   aadd( txt_, '      }                                                                                                                                    ' )
   aadd( txt_, '      else                                                                                                                                 ' )
   aadd( txt_, '      {                                                                                                                                    ' )
   aadd( txt_, '         s->list5 << NULL;                                                                                                                 ' )
   ...
   aadd( txt_, '/*----------------------------------------------------------------------*/                                                                 ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'MyMainWindow::MyMainWindow()                                                                                                               ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   Qt::WindowFlags flags = Qt::WindowCloseButtonHint    | Qt::WindowMaximizeButtonHint |                                                   ' )
   aadd( txt_, '                           Qt::WindowMinimizeButtonHint | Qt::WindowSystemMenuHint     |                                                   ' )
   aadd( txt_, '                           Qt::CustomizeWindowHint      | Qt::WindowTitleHint          |                                                   ' )
   aadd( txt_, '                           Qt::Window ;                                                                                                    ' )
   aadd( txt_, '   setWindowFlags( flags );                                                                                                                ' )
   aadd( txt_, '   setFocusPolicy( Qt::StrongFocus );                                                                                                      ' )
   aadd( txt_, '   setAttribute( Qt::WA_DeleteOnClose );                                                                                                   ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'MyMainWindow::~MyMainWindow( void )                                                                                                        ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void MyMainWindow::closeEvent( QCloseEvent *event )                                                                                        ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   event->accept();                                                                                                                        ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'MyDrawingArea::MyDrawingArea(QWidget *parent)                                                                                              ' )
   aadd( txt_, '    : QWidget(parent)                                                                                                                      ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   setAttribute( Qt::WA_StaticContents );                                                                                                  ' )
   aadd( txt_, '   setAttribute( Qt::WA_PaintOnScreen );                                                                                                   ' )
   aadd( txt_, '   setAttribute( Qt::WA_DeleteOnClose );                                                                                                   ' )
   aadd( txt_, '   setAttribute( Qt::WA_WindowPropagation );                                                                                               ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, '   setFocusPolicy( Qt::StrongFocus );                                                                                                      ' )
   aadd( txt_, '   setMouseTracking( true );                                                                                                               ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, '   setAttribute( Qt::WA_InputMethodEnabled, true );                                                                                        ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'MyDrawingArea::~MyDrawingArea( void )                                                                                                      ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, 'void MyDrawingArea::mouseMoveEvent( QMouseEvent * event )                                                                                  ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   emit sg_mouseMoveEvent( event );                                                                                                        ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, 'void MyDrawingArea::keyPressEvent( QKeyEvent * event )                                                                                     ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   emit sg_keyPressEvent( event );                                                                                                         ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'HB_FUNC( QT_MYMAINWINDOW )                                                                                                                 ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   hb_retptr( ( MyMainWindow * ) new MyMainWindow() );                                                                                     ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'HB_FUNC( QT_MYDRAWINGAREA )                                                                                                                ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   hb_retptr( ( MyDrawingArea * ) new MyDrawingArea() );                                                                                   ' )
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, '/*----------------------------------------------------------------------*/                                                                 ' )
   aadd( txt_, '#endif                                                                                                                                     ' )
...
STATIC FUNCTION Build_MOC_SLOTS_CPP( cPathOut )
   ...
   aadd( txt_, '/****************************************************************************                      ' )
   aadd( txt_, '** Meta object code from reading C++ file [hbqt_slots.h]                                           ' )
   aadd( txt_, '**                                                                                                 ' )
   aadd( txt_, '** Created: Mon Jun 15 00:25:52 2009                                                               ' )
   ...
   aadd( txt_, '#error "The header file [hbqt_slots.h] doesnot include <QObject>."                                 ' )
   ...
   aadd( txt_, '     114,  108,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     129,  108,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     154,  108,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     171,    6,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     187,  108,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     208,  108,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     235,  108,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     256,    6,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     285,  279,  274,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     300,  279,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     326,  279,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     362,  355,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '     380,  108,    6,    6, 0x0a,                                                                  ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, '       0        // eod                                                                             ' )
   aadd( txt_, '};                                                                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   ...
   aadd( txt_, '    "index\0activated(int)\0currentIndexChanged(int)\0"                                            ' )
   aadd( txt_, '    "highlighted(int)\0returnPressed()\0"                                                          ' )
   aadd( txt_, '    "clicked(QModelIndex)\0doubleClicked(QModelIndex)\0"                                           ' )
   aadd( txt_, '    "entered(QModelIndex)\0viewportEntered()\0"                                                    ' )
   aadd( txt_, '    "bool\0event\0event(QEvent*)\0"                                                                ' )
   aadd( txt_, '    "keyPressEvent(QKeyEvent*)\0"                                                                  ' )
   aadd( txt_, '    "mouseMoveEvent(QMouseEvent*)\0action\0"                                                       ' )
   aadd( txt_, '    "hovered(QAction*)\0currentChanged(int)\0"                                                     ' )
   aadd( txt_, '};                                                                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   ...
   aadd( txt_, '        case 7: activated((*reinterpret_cast< int(*)>(_a[1]))); break;                             ' )
   aadd( txt_, '        case 8: currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;                   ' )
   aadd( txt_, '        case 9: highlighted((*reinterpret_cast< int(*)>(_a[1]))); break;                           ' )
   aadd( txt_, '        case 10: returnPressed(); break;                                                           ' )
   aadd( txt_, '        case 11: clicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;                ' )
   aadd( txt_, '        case 12: doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;          ' )
   aadd( txt_, '        case 13: entered((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;                ' )
   aadd( txt_, '        case 14: viewportEntered(); break;                                                         ' )
   aadd( txt_, '        case 15: { bool _r = event((*reinterpret_cast< QEvent*(*)>(_a[1])));                       ' )
   aadd( txt_, '            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;                            ' )
   aadd( txt_, '        case 16: keyPressEvent((*reinterpret_cast< QKeyEvent*(*)>(_a[1]))); break;                 ' )
   aadd( txt_, '        case 17: mouseMoveEvent((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;              ' )
   aadd( txt_, '        case 18: hovered((*reinterpret_cast< QAction*(*)>(_a[1]))); break;                         ' )
   aadd( txt_, '        case 19: currentChanged((*reinterpret_cast< int(*)>(_a[1]))); break;                       ' )
   aadd( txt_, '        default: ;                                                                                 ' )
   aadd( txt_, '        }                                                                                          ' )
   aadd( txt_, '        _id -= 20;                                                                                 ' )
   aadd( txt_, '    }                                                                                              ' )
   aadd( txt_, '    return _id;                                                                                    ' )
   aadd( txt_, '}                                                                                                  ' )
   aadd( txt_, 'static const uint qt_meta_data_MyDrawingArea[] = {                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, ' // content:                                                                                       ' )
   aadd( txt_, '       2,       // revision                                                                        ' )
   aadd( txt_, '       0,       // classname                                                                       ' )
   aadd( txt_, '       0,    0, // classinfo                                                                       ' )
   aadd( txt_, '       2,   12, // methods                                                                         ' )
   aadd( txt_, '       0,    0, // properties                                                                      ' )
   aadd( txt_, '       0,    0, // enums/sets                                                                      ' )
   aadd( txt_, '       0,    0, // constructors                                                                    ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, ' // signals: signature, parameters, type, tag, flags                                               ' )
   aadd( txt_, '      21,   15,   14,   14, 0x05,                                                                  ' )
   aadd( txt_, '      53,   15,   14,   14, 0x05,                                                                  ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, '       0        // eod                                                                             ' )
   aadd( txt_, '};                                                                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'static const char qt_meta_stringdata_MyDrawingArea[] = {                                           ' )
   aadd( txt_, '    "MyDrawingArea\0\0event\0"                                                                     ' )
   aadd( txt_, '    "sg_mouseMoveEvent(QMouseEvent*)\0"                                                            ' )
   aadd( txt_, '    "sg_keyPressEvent(QKeyEvent*)\0"                                                               ' )
   aadd( txt_, '};                                                                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'const QMetaObject MyDrawingArea::staticMetaObject = {                                              ' )
   aadd( txt_, '    { &QWidget::staticMetaObject, qt_meta_stringdata_MyDrawingArea,                                ' )
   aadd( txt_, '      qt_meta_data_MyDrawingArea, 0 }                                                              ' )
   aadd( txt_, '};                                                                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'const QMetaObject *MyDrawingArea::metaObject() const                                               ' )
   aadd( txt_, '{                                                                                                  ' )
   aadd( txt_, '    return &staticMetaObject;                                                                      ' )
   aadd( txt_, '}                                                                                                  ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'void *MyDrawingArea::qt_metacast(const char *_clname)                                              ' )
   aadd( txt_, '{                                                                                                  ' )
   aadd( txt_, '    if (!_clname) return 0;                                                                        ' )
   aadd( txt_, '    if (!strcmp(_clname, qt_meta_stringdata_MyDrawingArea))                                        ' )
   aadd( txt_, '        return static_cast<void*>(const_cast< MyDrawingArea*>(this));                              ' )
   aadd( txt_, '    return QWidget::qt_metacast(_clname);                                                          ' )
   aadd( txt_, '}                                                                                                  ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'int MyDrawingArea::qt_metacall(QMetaObject::Call _c, int _id, void **_a)                           ' )
   aadd( txt_, '{                                                                                                  ' )
   aadd( txt_, '    _id = QWidget::qt_metacall(_c, _id, _a);                                                       ' )
   aadd( txt_, '    if (_id < 0)                                                                                   ' )
   aadd( txt_, '        return _id;                                                                                ' )
   aadd( txt_, '    if (_c == QMetaObject::InvokeMetaMethod) {                                                     ' )
   aadd( txt_, '        switch (_id) {                                                                             ' )
   aadd( txt_, '        case 0: sg_mouseMoveEvent((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;            ' )
   aadd( txt_, '        case 1: sg_keyPressEvent((*reinterpret_cast< QKeyEvent*(*)>(_a[1]))); break;               ' )
   aadd( txt_, '        default: ;                                                                                 ' )
   aadd( txt_, '        }                                                                                          ' )
   aadd( txt_, '        _id -= 2;                                                                                  ' )
   aadd( txt_, '    }                                                                                              ' )
   ...
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, '// SIGNAL 0                                                                                        ' )
   aadd( txt_, 'void MyDrawingArea::sg_mouseMoveEvent(QMouseEvent * _t1)                                           ' )
   aadd( txt_, '{                                                                                                  ' )
   aadd( txt_, '    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };                    ' )
   aadd( txt_, '    QMetaObject::activate(this, &staticMetaObject, 0, _a);                                         ' )
   aadd( txt_, '}                                                                                                  ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, '// SIGNAL 1                                                                                        ' )
   aadd( txt_, 'void MyDrawingArea::sg_keyPressEvent(QKeyEvent * _t1)                                              ' )
   aadd( txt_, '{                                                                                                  ' )
   aadd( txt_, '    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };                    ' )
   aadd( txt_, '    QMetaObject::activate(this, &staticMetaObject, 1, _a);                                         ' )
   aadd( txt_, '}                                                                                                  ' )
   aadd( txt_, 'static const uint qt_meta_data_MyMainWindow[] = {                                                  ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, ' // content:                                                                                       ' )
   aadd( txt_, '       2,       // revision                                                                        ' )
   aadd( txt_, '       0,       // classname                                                                       ' )
   aadd( txt_, '       0,    0, // classinfo                                                                       ' )
   aadd( txt_, '       0,    0, // methods                                                                         ' )
   aadd( txt_, '       0,    0, // properties                                                                      ' )
   aadd( txt_, '       0,    0, // enums/sets                                                                      ' )
   aadd( txt_, '       0,    0, // constructors                                                                    ' )
   aadd( txt_, '                                                                                                   ' )
   ...
   aadd( txt_, '};                                                                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'static const char qt_meta_stringdata_MyMainWindow[] = {                                            ' )
   aadd( txt_, '    "MyMainWindow\0"                                                                               ' )
   aadd( txt_, '};                                                                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'const QMetaObject MyMainWindow::staticMetaObject = {                                               ' )
   aadd( txt_, '    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MyMainWindow,                             ' )
   aadd( txt_, '      qt_meta_data_MyMainWindow, 0 }                                                               ' )
   aadd( txt_, '};                                                                                                 ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'const QMetaObject *MyMainWindow::metaObject() const                                                ' )
   aadd( txt_, '{                                                                                                  ' )
   aadd( txt_, '    return &staticMetaObject;                                                                      ' )
   aadd( txt_, '}                                                                                                  ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'void *MyMainWindow::qt_metacast(const char *_clname)                                               ' )
   aadd( txt_, '{                                                                                                  ' )
   aadd( txt_, '    if (!_clname) return 0;                                                                        ' )
   aadd( txt_, '    if (!strcmp(_clname, qt_meta_stringdata_MyMainWindow))                                         ' )
   aadd( txt_, '        return static_cast<void*>(const_cast< MyMainWindow*>(this));                               ' )
   aadd( txt_, '    return QMainWindow::qt_metacast(_clname);                                                      ' )
   aadd( txt_, '}                                                                                                  ' )
   aadd( txt_, '                                                                                                   ' )
   aadd( txt_, 'int MyMainWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)                            ' )
   aadd( txt_, '{                                                                                                  ' )
   aadd( txt_, '    _id = QMainWindow::qt_metacall(_c, _id, _a);                                                   ' )
   aadd( txt_, '    if (_id < 0)                                                                                   ' )
   aadd( txt_, '        return _id;                                                                                ' )
   aadd( txt_, '    return _id;                                                                                    ' )
   aadd( txt_, '}                                                                                                  ' )
...
STATIC FUNCTION Build_Demo()
   ...
   aadd( txt_, '                                                                                                                                     ' )
   aadd( txt_, '#define QT_EVE_TRIGGERED             "triggered()"                                                                                   ' )
   ...
   aadd( txt_, '#define QT_EVE_STATECHANGED_I        "stateChanged(int)"                                                                             ' )
   aadd( txt_, '#define QT_EVE_PRESSED               "pressed()"                                                                                     ' )
   aadd( txt_, '#define QT_EVE_RELEASED              "released()"                                                                                    ' )
   aadd( txt_, '#define QT_EVE_ACTIVATED_I           "activated(int)"                                                                                ' )
   aadd( txt_, '#define QT_EVE_CURRENTINDEXCHANGED_I "currentIndexChanged(int)"                                                                      ' )
   aadd( txt_, '#define QT_EVE_HIGHLIGHTED_I         "highlighted(int)"                                                                              ' )
   aadd( txt_, '#define QT_EVE_RETURNPRESSED         "returnPressed()"                                                                               ' )
   aadd( txt_, '#define QT_EVE_CLICKED_M             "clicked(QModelIndex)"                                                                          ' )
   aadd( txt_, '#define QT_EVE_VIEWPORTENTERED       "viewportEntered()"                                                                             ' )
   aadd( txt_, '                                                                                                                                     ' )
   aadd( txt_, '/*----------------------------------------------------------------------*/                                                           ' )
   aadd( txt_, '/*                                                                                                                                   ' )
   aadd( txt_, ' *                               A NOTE                                                                                              ' )
   ...
   aadd( txt_, '   oWnd:setMouseTracking( .t. )                                                                                                      ' )
   ...
   aadd( txt_, '   oTV:setMouseTracking( .t. )                                                                                                       ' )
   aadd( txt_, '   Qt_Connect_Signal( QT_PTROF( oTV ), QT_EVE_HOVERED, {|o,i| uiDebug( "oTV:hovered" ) } )                                           ' )
   ...
   aadd( txt_, '   LOCAL oListBox, oStrList, oStrModel, oAct                                                                                         ' )
   aadd( txt_, '                                                                                                                                     ' )
   aadd( txt_, '   oListBox := QListView():New( QT_PTROF( oWnd ) )                                                                                   ' )
   aadd( txt_, '   oListBox:setMouseTracking( .t. )                                                                                                  ' )
   aadd( txt_, '   Qt_Connect_Signal( QT_PTROF( oListBox ), QT_EVE_HOVERED, {|o,i| uiDebug( "oListBox:hovered" ) } )                                 ' )
   aadd( txt_, '                                                                                                                                     ' )
   ...
   aadd( txt_, '   Qt_Connect_Signal( QT_PTROF( oEdit ), QT_EVE_RETURNPRESSED, {|o,i| MsgInfo( oEdit:text() ) } )                                    ' )
   ...
   aadd( txt_, '   Qt_Connect_Signal( QT_PTROF( oComboBox ), QT_EVE_HIGHLIGHTED_I        , {|o,i| uiDebug( oComboBox:itemText( i ) ) } )             ' )
   aadd( txt_, '   Qt_Connect_Signal( QT_PTROF( oComboBox ), QT_EVE_CURRENTINDEXCHANGED_I, {|o,i| MsgInfo( oComboBox:itemText( i ) ) } )             ' )
   ...
   aadd( txt_, '   Qt_Connect_Signal( QT_PTROF( oCheckBox ), QT_EVE_STATECHANGED_I, {|o,i| MsgInfo( IF( i == 0,"Uncheckd","Checked" ) ) } )          ' )
   ...
   aadd( txt_, '   Qt_Connect_Signal( QT_PTROF( oRadioButton ), QT_EVE_CLICKED, {|o,i| MsgInfo( "Checked" ) } )                                      ' )
