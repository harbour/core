...
STATIC FUNCTION Build_HBQT_SLOTS_H( cPathOut )
   ...
   aadd( txt_, '   void clicked_model( const QModelIndex & index );  ' )
...
STATIC FUNCTION Build_HBQT_SLOTS_CPP( cPathOut )
   ...
   aadd( txt_, '}                                                                                                                                          ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, 'void Slots::clicked_model( const QModelIndex & index )                                                                                     ' )
   aadd( txt_, '{                                                                                                                                          ' )
   aadd( txt_, '   QWidget * widget = qobject_cast<QWidget *>( sender() );                                                                                 ' )
   aadd( txt_, '   for( int i = 0; i < list1.size(); ++i )                                                                                                 ' )
   aadd( txt_, '   {                                                                                                                                       ' )
   ...
   aadd( txt_, '      {                                                                                                                                    ' )
   aadd( txt_, '         if( ( ( QString ) list2.at( i ) == ( QString ) "clicked(QModelIndex)" ) && ( ( bool ) list4.at( i ) == true ) )                   ' )
   aadd( txt_, '         {                                                                                                                                 ' )
   aadd( txt_, '            PHB_ITEM pWidget = hb_itemPutPtr( NULL, ( QWidget * ) widget );                                                                ' )
   aadd( txt_, '            PHB_ITEM pState = hb_itemPutPtr( NULL, ( QModelIndex * ) new QModelIndex( index ) );                                           ' )
   aadd( txt_, '                                                                                                                                           ' )
   aadd( txt_, '            hb_vmEvalBlockV( ( PHB_ITEM ) list3.at( i ), 1, pWidget, pState );                                                             ' )
   aadd( txt_, '            hb_itemRelease( pWidget );                                                                                                     ' )
   aadd( txt_, '            hb_itemRelease( pState );                                                                                                      ' )
   aadd( txt_, '         }                                                                                                                                 ' )
   aadd( txt_, '      }                                                                                                                                    ' )
   ...
   aadd( txt_, '   {                                                                                                                                       ' )
   aadd( txt_, '      ret = widget->connect( widget, SIGNAL( clicked_model( const QModelIndex & ) ),                                                       ' )
...
STATIC FUNCTION Build_MOC_SLOTS_CPP( cPathOut )
   ...
   aadd( txt_, '**                                                                                           ' )
   aadd( txt_, '** Created: Sat Jun 13 14:02:48 2009                                                         ' )
   ...
   aadd( txt_, '#error "The header file hbqt_slots.h doesnt include <QObject>."                              ' )
   ...
   aadd( txt_, '     214,    6,    6,    6, 0x0a,                                                            ' )
   aadd( txt_, '     243,  237,  232,    6, 0x0a,                                                            ' )
   aadd( txt_, '     258,  237,    6,    6, 0x0a,                                                            ' )
   aadd( txt_, '     284,  237,    6,    6, 0x0a,                                                            ' )
   aadd( txt_, '     320,  313,    6,    6, 0x0a,                                                            ' )
   aadd( txt_, '                                                                                             ' )
   aadd( txt_, '       0        // eod                                                                       ' )
   aadd( txt_, '};                                                                                           ' )
   aadd( txt_, '                                                                                             ' )
   ...
   aadd( txt_, '        case 11: clicked_model((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;    ' )
   aadd( txt_, '        case 12: viewportEntered(); break;                                                   ' )
   aadd( txt_, '        case 13: { bool _r = event((*reinterpret_cast< QEvent*(*)>(_a[1])));                 ' )
   aadd( txt_, '            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;                      ' )
   aadd( txt_, '        case 14: keyPressEvent((*reinterpret_cast< QKeyEvent*(*)>(_a[1]))); break;           ' )
   aadd( txt_, '        case 15: mouseMoveEvent((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;        ' )
   aadd( txt_, '        case 16: hovered((*reinterpret_cast< QAction*(*)>(_a[1]))); break;                   ' )
   aadd( txt_, '        default: ;                                                                           ' )
   aadd( txt_, '        }                                                                                    ' )
   aadd( txt_, '        _id -= 17;                                                                           ' )
   aadd( txt_, '    }                                                                                        ' )
