...
%description -l pl
%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator rozwijany na
...
%description -l ru
%{dname} - ÕŒœ«œ–Ã¡‘∆œ“Õ≈ŒŒŸ  ÀœÕ–…Ã—‘œ“, ”œ◊Õ≈”‘…ÕŸ  ” —⁄ŸÀœÕ CA-Clipper.
¸‘œ‘ –¡À≈‘ ”œƒ≈“÷…‘ ÀœÕ–…Ã—‘œ“, –“≈–“œ√≈””œ“, ∆¡ ÃŸ ⁄¡«œÃœ◊Àœ◊, ◊…“‘’¡ÃÿŒ’¿
Õ¡€…Œ’ … ƒœÀ’Õ≈Œ‘¡√…¿.

%description -l hu
%{dname} egy tˆbb platformon is m˚kˆdı CA-Clipper kompatibilis 
...
%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator.
...
%{dname} - ÀœÕ–…Ã—‘œ“, ”œ◊Õ≈”‘…ÕŸ  ” —⁄ŸÀœÕ CA-Clipper.
...
%{?_with_odbc:%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator.}
...
%{?_with_curl:%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator.}
...
%{?_with_hbhpdf:%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator.}
...
%{?_with_ads:%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator.}
...
%{?_with_mysql:%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator.}
...
%{?_with_pgsql:%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator.}
...
%{?_with_gd:%{dname} to kompatybilny z jÍzykiem CA-Clipper kompilator.}
