...
%define hb_ctrb   export HB_CONTRIBLIBS="hbbtree hbclipsm hbct hbgt hbmisc hbmzip hbnetio hbtip hbtpathy hbhpdf hbsms hbziparc hbfoxpro hbfship hbxpp xhb rddbmcdx rddsql hbnf %{?_with_allegro:gtalleg} %{?_with_cairo:hbcairo} %{?_with_curl:hbcurl} %{?_with_firebird:hbfbird} %{?_with_freeimage:hbfimage} %{?_with_gd:hbgd} %{?_with_mysql:hbmysql} %{?_with_odbc:hbodbc} %{?_with_pgsql:hbpgsql} %{?_with_qt:hbqt hbxbp} %{?_with_ads:rddads}"
...
%{?_with_allegro:%{dname} to kompatybilny z jÍzykiem CA-Cl*pper kompilator.}
%{?_with_allegro:Ten pakiet udostÍpnia statyczn+ biliotekÍ Allegro GT dla kompilatora %{dname}.}
...
%{?_with_cairo:%{dname} to kompatybilny z jÍzykiem CA-Cl*pper kompilator.}
%{?_with_cairo:Ten pakiet udostÍpnia statyczn+ biliotekÍ Cairo dla kompilatora %{dname}.}
...
%{?_with_firebird:%{dname} to kompatybilny z jÍzykiem CA-Cl*pper kompilator.}
%{?_with_firebird:Ten pakiet udostÍpnia statyczn+ biliotekÍ FireBird dla kompilatora %{dname}.}
...
#%{?_with_freeimage:%{dname} to kompatybilny z jÍzykiem CA-Cl*pper kompilator.}
#%{?_with_freeimage:Ten pakiet udostÍpnia statyczn+ biliotekÍ FreeImage dla kompilatora %{dname}.}
