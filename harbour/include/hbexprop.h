...
extern HB_EXPR_PTR hb_compExprNewString( const char * szValue, HB_SIZE ulLen, HB_BOOL fDealloc, HB_COMP_DECL );
extern HB_EXPR_PTR hb_compExprNewLogical( int iValue, HB_COMP_DECL );
extern HB_EXPR_PTR hb_compExprNewSelf( HB_COMP_DECL );
extern HB_EXPR_PTR hb_compExprNewCodeBlock( char * string, HB_SIZE ulLen, int iFlags, HB_COMP_DECL );
...
extern HB_EXPR_PTR hb_compExprSetCodeblockBody( HB_EXPR_PTR pExpr, HB_BYTE * pCode, HB_SIZE ulLen );
