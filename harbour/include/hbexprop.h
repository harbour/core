...
extern HB_EXPR_PTR hb_compExprNewString( const char * szValue, HB_ULONG ulLen, HB_BOOL fDealloc, HB_COMP_DECL );
extern HB_EXPR_PTR hb_compExprNewLogical( int iValue, HB_COMP_DECL );
extern HB_EXPR_PTR hb_compExprNewSelf( HB_COMP_DECL );
extern HB_EXPR_PTR hb_compExprNewCodeBlock( char * string, HB_ULONG ulLen, int iFlags, HB_COMP_DECL );
