...
extern HB_EXPORT HB_SIZE      hb_itemGetNSize  ( PHB_ITEM pItem );
...
extern HB_EXPORT PHB_ITEM     hb_itemPutCLConst( PHB_ITEM pItem, const char * szText, HB_SIZE ulLen );
...
extern HB_EXPORT PHB_ITEM     hb_itemPutNSize  ( PHB_ITEM pItem, HB_SIZE nNumber );
