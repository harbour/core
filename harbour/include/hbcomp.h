...
extern void hb_compSequenceFinish( HB_COMP_DECL, HB_ULONG ulStartPos, HB_ULONG ulEndPos,
...
extern int  hb_compMain( int argc, const char * const argv[], HB_BYTE ** pBufPtr, HB_SIZE * pulSize, const char * szSource );
