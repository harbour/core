...
echo "hb21\bin\hbmk.cfg"                          >> _hbfiles
echo "hb21\bin\upx*.*"                            >> _hbfiles
echo "hb21\include\*.*"                           >> _hbfiles
echo "hb21\bin\hbi18n-dll.exe"                    >> _hbfiles
echo "hb21\bin\hbmk2-dll.exe"                     >> _hbfiles
echo "hb21\bin\hbrun-dll.exe"                     >> _hbfiles
echo "hb21\bin\hbtest-dll.exe"                    >> _hbfiles
echo "hb21\bin\hbformat-dll.exe"                  >> _hbfiles
