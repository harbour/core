...
rem ; Using msvc64 because mingw64 .dll handling is broken.
 ...
 copy /y       ..\..\pkg\win\msvc64\harbour-2.1.0-win-msvc64\bin\hbformat-dll.exe  F:\hb\hb21\bin\hbformat-x64.exe
 copy /y       ..\..\pkg\win\msvc64\harbour-2.1.0-win-msvc64\bin\hbi18n-dll.exe    F:\hb\hb21\bin\hbi18n-x64.exe
 copy /y       ..\..\pkg\win\msvc64\harbour-2.1.0-win-msvc64\bin\hbmk2-dll.exe     F:\hb\hb21\bin\hbmk2-x64.exe
 copy /y       ..\..\pkg\win\msvc64\harbour-2.1.0-win-msvc64\bin\hbrun-dll.exe     F:\hb\hb21\bin\hbrun-x64.exe
 copy /y       ..\..\pkg\win\msvc64\harbour-2.1.0-win-msvc64\bin\hbtest-dll.exe    F:\hb\hb21\bin\hbtest-x64.exe
