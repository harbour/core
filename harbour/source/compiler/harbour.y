 ...
 * 8) Support this syntax: nPtr := @Hello()
 * 9) Support for syntax: FOR [ array | object | alias_expr | other ] := value
 */
...
VarAssign  : IDENTIFIER             INASSIGN Expression { PopId( $1 ); SetLastPushPos(); PushId( $1 ); }
           ...
           | AliasVar               INASSIGN { $<pVoid>$=( void * ) pAliasId; pAliasId = NULL; } Expression { pAliasId=(ALIASID_PTR) $<pVoid>3; PopId( $1 ); SetLastPushPos(); PushId( $1 ); AliasRemove(); }
