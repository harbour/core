...
#define HB_DLL_NAMEMT  TEXT( "harbourmt.dll" )
   ...
   #define HB_DLL_NAME2   TEXT( "harbour-20-arm.dll" )
   #define HB_DLL_NAMEMT2 TEXT( "harbourmt-20-arm.dll" )
   ...
   #define HB_DLL_NAME2   TEXT( "harbour-20-ia64.dll" )
   #define HB_DLL_NAMEMT2 TEXT( "harbourmt-20-ia64.dll" )
#else
   #define HB_DLL_NAME2   TEXT( "harbour-20.dll" )
   #define HB_DLL_NAMEMT2 TEXT( "harbourmt-20.dll" )
#endif
