...

{
   ...
   pPage = hb_xgrab( sizeof( HB_PAGEINFO ) );
   ...
   pPage->pKeys = hb_xgrab( sizeof( KEYINFO ) * ( pParentTag->MaxKeys + 1 ) );
...

{
   ...
   pPage->pKeys = hb_xgrab( sizeof( KEYINFO ) * ( pPage->TagParent->MaxKeys + 1 ) );
...

{
   ...
   pIndex->IndexName = hb_xgrab( _POSIX_PATH_MAX + 1 );
