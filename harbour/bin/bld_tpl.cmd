...
:A_DOS
   ...
   if "%HB_COMPILER%" == "djgpp"   gcc %1.c -o%1.exe -I..\include -L..\lib -ltools -ldebug -lvm -lrtl -l%HB_GT_LIB%.lib -lrdd -lrtl -lvm -lmacro -lpp -ldbfnt -ldbfcd -lcommon
   goto END
...
:A_W32
   ...
   if "%HB_COMPILER%" == "gcc"     gcc %1.c -o%1.exe -I..\include -L..\lib -ltools -ldebug -lvm -lrtl -l%HB_GT_LIB%.lib -lrdd -lrtl -lvm -lmacro -lpp -ldbfntx -ldbfcdx -lcommon
   if "%HB_COMPILER%" == "mingw32" gcc %1.c -o%1.exe -mno-cygwin -I..\include -L..\lib -ltools -ldebug -lvm -lrtl -l%HB_GT_LIB%.lib -lrdd -lrtl -lvm -lmacro -lpp -ldbfntx -ldbfcdx -lcommon
