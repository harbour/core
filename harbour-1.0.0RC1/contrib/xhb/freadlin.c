...
HB_FUNC( HB_FREADLINE )
{
   ...
   {
      hb_errRT_BASE_SubstR( EG_ARG, 3012, NULL, "HB_FREADLINE", 4, hb_paramError(1), hb_paramError(2), hb_paramError(3), hb_paramError(4) );
      return;
   }
   ...
   if( ISARRAY( 3 ) || ISCHAR( 3 ) )
   {
      if( ISARRAY( 3 ) )
      {
         ...
         if( iTerms <= 0 )
         {
            hb_errRT_BASE_SubstR( EG_ARG, 3012, NULL, "HB_FREADLINE", 4,
