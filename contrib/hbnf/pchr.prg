   ...
   DO WHILE !( c_part == "~" .OR. c_part == "" )
      ...
      ELSE
         ...
         IF hb_LeftIs( c_part, "/" )
            ...
            DO CASE
            CASE hb_LeftIs( c_upper, "/GRAPHIC" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 116 ) + hb_BChar( 1 )
            CASE hb_LeftIs( c_upper, "/ITALIC" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 116 ) + hb_BChar( 0 )
            CASE hb_LeftIs( c_upper, "/PICTURE" )
               c_ret += ;
            ...
            CASE hb_LeftIs( c_upper, "/COND" ) .OR. hb_LeftIs( c_upper, "/SI" )
               c_ret += hb_BChar( 15 )
            CASE hb_LeftIs( c_upper, "/ROMAN" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 107 ) + hb_BChar( 0 )
            CASE hb_LeftIs( c_upper, "/SANS" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 107 ) + hb_BChar( 1 )
            CASE hb_LeftIs( c_upper, "/NLQ" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 120 ) + hb_BChar( 1 )
            CASE hb_LeftIs( c_upper, "/DRAFT" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 120 ) + hb_BChar( 0 )
            CASE hb_LeftIs( c_upper, "/ELITE" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 77 )
            CASE hb_LeftIs( c_upper, "/PICA" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 80 )
            CASE hb_LeftIs( c_upper, "/EMPHOFF" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 70 )
            CASE hb_LeftIs( c_upper, "/EMPH" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 69 )
            CASE hb_LeftIs( c_upper, "/1/6" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 50 )
            CASE hb_LeftIs( c_upper, "/1/8" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 48 )
            CASE hb_LeftIs( c_upper, "/SKIPOFF" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 79 )
            CASE hb_LeftIs( c_upper, "/SKIP" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 78 )
            CASE hb_LeftIs( c_upper, "/FF" ) .OR. hb_LeftIs( c_upper, "/EJECT" )
               c_ret += hb_BChar( 12 )
            CASE hb_LeftIs( c_upper, "/INIT" ) .OR. hb_LeftIs( c_upper, "/RESET" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 64 )
            CASE hb_LeftIs( c_upper, "/SPANISH" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 82 ) + hb_BChar( 12 )
            CASE hb_LeftIs( c_upper, "/USA" )
               c_ret += hb_BChar( 27 ) + hb_BChar( 82 ) + hb_BChar( 0 )
            CASE hb_LeftIs( c_upper, "/ONE" )
               c_ret += hb_BChar( 27 ) + "U" + hb_BChar( 1 )
            CASE hb_LeftIs( c_upper, "/TWO" )
               c_ret += hb_BChar( 27 ) + "U" + hb_BChar( 0 )
            CASE hb_LeftIs( c_upper, "/FAST" )
               c_ret += hb_BChar( 27 ) + "s" + hb_BChar( 0 )
            CASE hb_LeftIs( c_upper, "/SLOW" )
               c_ret += hb_BChar( 27 ) + "s" + hb_BChar( 1 )
            CASE hb_LeftIs( c_upper, "/OFF" )
               c_ret += hb_BChar( 19 )
            CASE hb_LeftIs( c_upper, "/ON" )
               c_ret += hb_BChar( 17 )
            CASE hb_LeftIs( c_upper, "/BEEP" ) .OR. hb_LeftIs( c_upper, "/BELL" )
               c_ret += hb_BChar( 7 )
            CASE hb_LeftIs( c_upper, "/CAN" )
               c_ret += hb_BChar( 24 )
            ENDCASE
         ENDIF
      ENDIF
