...
Syntax:  
  ...
  hbmk2 &lt;file\[\.hb|\.prg|\.hrb|\.dbf\]&gt;|&lt;option&gt; \[parameters\[s\]\]  
  
Description:  


  hbmk2 is able to run Harbour scripts \(both source and precompiled\), and it also features an interactive shell prompt\.
