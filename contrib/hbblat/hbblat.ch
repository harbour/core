...
#define BLAT_ERR_CANT_RESOLVE_HOSTNAME                 4007  // "Could not resolve (mailserver) hostname."
#define BLAT_ERR_CANT_GET_SOCKET                       4008  // "Could not create a socket (too many simultaneous links?)"
...
#define BLAT_ERR_CANT_RESOLVE_SERVICE                  4014  // "Could not resolve service."
#define BLAT_ERR_CANT_CONNECT                          4015  // "Could not connect to mailserver (timed out if winsock.dll error 10060)"
