...
//{
//    uint32_t sd = UINT32_MAX, sm = UINT32_MAX, sy = UINT32_MAX;
//    uint32_t ed = UINT32_MAX, em = UINT32_MAX, ey = UINT32_MAX;
//    char_t lsep = 0;
//    uint32_t i = 0;
...
//    }
//
//    /* Two consecutive digits for day */
//    if (ed - sd != 2)
//        return FALSE;
//
//    /* Two consecutive digits for month */
//    if (em - sm != 2)
//        return FALSE;
//
//    /* Two/four consecutive digits for year */
//    if (ey - sy != 2 && ey - sy != 4)
//        return FALSE;
//
//    if (d != NULL)
