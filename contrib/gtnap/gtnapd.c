...
static void i_OnClose(Window *window, Event *e)
{
   window_hide(window);
}

static Window *i_nappgui_window(void)
{
   ...
   window_title(window, "gtnap NAppGUI Window");
   window_OnClose(window, listener(window, i_OnClose, Window));
   return window;
}
