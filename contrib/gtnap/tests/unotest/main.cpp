...
int main()
{
    ...
    // Windows
    rtl::OUString sDocUrl("file:///C:/harbour_nappgui/contrib/gtnap/tests/unotest/test.odt"), sPDFUrl("file:///C:/harbour_nappgui/contrib/gtnap/tests/unotest/test.pdf");
    rtl::OUString sConnectionString("uno:socket,host=localhost,port=2083;urp;StarOffice.ServiceManager");
    ...
    try
    {
        ...
        try
        {
            ...
            storeProps[2].Value <<= (sal_uInt32)1;
