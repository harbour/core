/* encoding: cp850 */
*
* Cont�m rotinas que a CUA cita, mas que est�o em outros PRGs.
* Servem apenas para n�o dar erro de linkedi��o,
* n�o tendo tratamento dentro de cada rotina "stub".
*
#INCLUDE "ord.ch"
#INCLUDE "inkey.ch"
#INCLUDE "cua.ch"
...
//    MOSTRAR("M?????","A cl�usula AJUDA cont�m ;'"+C_CdJane+"' para a tela,;"+;
//                      "'"+C_CABEC+"' para t�tulo.")
// ELSE
//    MOSTRAR("M15562","A cl�usula AJUDA cont�m ;'"+C_CdJane+"' para a tela,;"+;
//                     "'"+C_CABEC+"' para t�tulo,;"+;
