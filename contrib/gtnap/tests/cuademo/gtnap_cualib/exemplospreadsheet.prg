...
LOCAL O_XLS := HBOFFICE_XLS_OPEN( NAP_WORK_PATH() + "/../office/empty.ods" )

IF OFFICE_ERROR("Abrindo a planilha")
    RETURN
ENDIF

HBOFFICE_XLS_CELL_TEXT(O_XLS, 0, 0, 0, "Hello World! (0,0)")
HBOFFICE_XLS_CELL_FONT_FAMILY(O_XLS, 0, 0, 0, "Arial")
HBOFFICE_XLS_CELL_FONT_SIZE(O_XLS, 0, 0, 0, 16.0)

HBOFFICE_XLS_CELL_TEXT(O_XLS, 0, 0, 1, "Hello World! (0,1)")
HBOFFICE_XLS_CELL_FONT_FAMILY(O_XLS, 0, 0, 1, "Times New Roman")
HBOFFICE_XLS_CELL_FONT_SIZE(O_XLS, 0, 0, 1, 20.0)
HBOFFICE_XLS_CELL_BOLD(O_XLS, 0, 0, 1, .T.)
HBOFFICE_XLS_CELL_ITALIC(O_XLS, 0, 0, 1, .T.)

HBOFFICE_XLS_CELL_TEXT(O_XLS, 0, 0, 2, {|| "Hello World! (0,2)"})

HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, 0, 0, 6000)
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, 0, 1, 12000)
HBOFFICE_XLS_COLUMN_VISIBLE(O_XLS, 0, 2, .F.)

// Save an edited spreadsheet
HBOFFICE_XLS_SAVE(O_XLS, {|| NAP_WORK_PATH() + "/../office/edited.ods" })
...
HBOFFICE_BROWSE_DOC(NAP_WORK_PATH() + "/../office/edited.ods")
...
HBOFFICE_XLS_SAVE(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_01.ods" })
OFFICE_ERROR("Salvando a planilha")
...
// Open the result into a LibreOffice window
HBOFFICE_BROWSE_DOC(NAP_WORK_PATH() + "/../office/ods_gen/Exemple_01.ods")
...
HBOFFICE_XLS_CELL_IMAGE(O_XLS, N_Page, 0, 0, {|| NAP_WORK_PATH() + "/../office/ods/cell_image_01.png" })
...
// Save the spreadsheet
HBOFFICE_XLS_SAVE(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_02.ods" })
OFFICE_ERROR("Salvando a planilha")

// Export to PDF
HBOFFICE_XLS_PDF(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_02.pdf" })
OFFICE_ERROR("Exportando para PDF")

// Print spreadsheet
HBOFFICE_XLS_PRINT(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Print_03.pdf" }, "", HBOFFICE_PAPER_ORIENT_PORTRAIT, HBOFFICE_PAPER_FORMAT_A4, 0, 0, 1, .F., "1-")
//HBOFFICE_XLS_PRINT(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Print_02.pdf" }, "Microsoft Print to PDF", HBOFFICE_PAPER_ORIENT_LANSCAPE, HBOFFICE_PAPER_FORMAT_USER, 30000, 60000, 1, .F., "")
...
// Open the result into a LibreOffice window
HBOFFICE_BROWSE_DOC(NAP_WORK_PATH() + "/../office/ods_gen/Exemple_02.ods")


***********************************
STAT PROC Text3(O_XLS, N_Page, N_Col, N_Row, C_Text, N_HAlign, N_Size, L_Bold)
    HBOFFICE_XLS_CELL_TEXT(O_XLS, N_Page, N_Col, N_Row, C_Text)
    HBOFFICE_XLS_CELL_FONT_FAMILY(O_XLS, N_Page, N_Col, N_Row, "Times New Roman")
    HBOFFICE_XLS_CELL_FONT_SIZE(O_XLS, N_Page, N_Col, N_Row, N_Size)
    HBOFFICE_XLS_CELL_HALIGN(O_XLS, N_Page, N_Col, N_Row, N_HAlign)
    HBOFFICE_XLS_CELL_BOLD(O_XLS, N_Page, N_Col, N_Row, L_Bold)
...
STAT PROC Value3(O_XLS, N_Page, N_Col, N_Row, N_Value, N_Size, L_Bold)
    ...
    HBOFFICE_XLS_CELL_HALIGN(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_HALIGN_RIGHT)
    HBOFFICE_XLS_CELL_BOLD(O_XLS, N_Page, N_Col, N_Row, L_Bold)
    HBOFFICE_XLS_CELL_NUMFORMAT(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_NUMFORMAT_DEC2_1000)
    HBOFFICE_XLS_CELL_VALUE(O_XLS, N_Page, N_Col, N_Row, N_Value)
...
HBOFFICE_XLS_NAME(O_XLS, 0, "Anexo 3 - RCL Municípios")

// Remove all grid lines
HBOFFICE_XLS_CELLS_BACKCOLOR(O_XLS, N_Page, 0, 0, 1000, 1000, HBOFFICE_RGB(255, 255, 255))

// Column widths
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 0, 10973)
FOR N_Cont := 1 TO 12
    HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, N_Cont, 2337)
NEXT
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 13, 2642)
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 14, 2642)

// Row heights
FOR N_Cont := 1 TO 11
    HBOFFICE_XLS_ROW_HEIGHT(O_XLS, N_Page, N_Cont, 406)
NEXT
FOR N_Cont := 12 TO 39
    HBOFFICE_XLS_ROW_HEIGHT(O_XLS, N_Page, N_Cont, 508)
NEXT

// Borders
HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 9, 0, 11, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, 1, 9, 12, 10, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, 13, 9, 13, 11, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, 14, 9, 14, 11, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
FOR N_Cont := 1 TO 12
    HBOFFICE_XLS_CELL_BORDER(O_XLS, N_Page, N_Cont, 11, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
NEXT
FOR N_Cont := 0 TO 14
    HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, N_Cont, 12, N_Cont, 39, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
NEXT

// Gray headers
HBOFFICE_XLS_CELLS_BACKCOLOR(O_XLS, N_Page, 0, 9, 14, 11, HBOFFICE_RGB(217, 217, 217))
HBOFFICE_XLS_CELLS_MERGE(O_XLS, N_Page, 1, 9, 12, 10)
Head3(O_XLS, N_Page, 0, 10, "ESPECIFICAÇÃO")
Head3(O_XLS, N_Page, 1, 9, "EVOLUÇÃO DA RECEITA REALIZADA NOS ÚLTIMOS 12 MESES")
HBOFFICE_XLS_CELL_VALIGN(O_XLS, N_Page, 1, 9, HBOFFICE_VALIGN_CENTER)
...
// Save the spreadsheet
HBOFFICE_XLS_SAVE(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_03.ods" })
OFFICE_ERROR("Salvando a planilha")

// Export to PDF
HBOFFICE_XLS_PDF(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_03.pdf" })
OFFICE_ERROR("Exportando para PDF")
...
// Open the result into a LibreOffice window
HBOFFICE_BROWSE_DOC(NAP_WORK_PATH() + "/../office/ods_gen/Exemple_03.ods")
...
// Column widths
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 0, 900)
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 1, 11000)
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 2, 2010)
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 3, 2490)
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 4, 1804)
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 5, 2010)
HBOFFICE_XLS_COLUMN_WIDTH(O_XLS, N_Page, 6, 2110)

// Row heights
FOR N_Cont := 0 TO 43
    HBOFFICE_XLS_ROW_HEIGHT(O_XLS, N_Page, N_Cont, 458)
NEXT

// Merge Cells
FOR N_Cont := 0 TO 15
    HBOFFICE_XLS_CELLS_MERGE(O_XLS, N_Page, 0, N_Cont, 6, N_Cont)
NEXT

// Background color
HBOFFICE_XLS_CELLS_BACKCOLOR(O_XLS, N_Page, 0, 0, 6, 0, HBOFFICE_RGB(255, 255, 0))

// Borders
HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 0, 6, 0, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 1, 6, 2, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 3, 6, 8, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
HBOFFICE_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 9, 6, 15, HBOFFICE_LINE_STYLE_SOLID, 25, HBOFFICE_RGB(0, 0, 0))
...
HBOFFICE_XLS_CELLS_MERGE(O_XLS, N_Page, 0, 16, 6, 27)
HBOFFICE_XLS_CELL_WRAP(O_XLS, N_Page, 0, 16, .T.)
HBOFFICE_XLS_CELL_VALIGN(O_XLS, N_Page, 0, 16, HBOFFICE_VALIGN_CENTER)
...
// Save the spreadsheet
HBOFFICE_XLS_SAVE(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_04.ods" })
OFFICE_ERROR("Salvando a planilha")

// Export to PDF
HBOFFICE_XLS_PDF(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_04.pdf" })
OFFICE_ERROR("Exportando para PDF")
...
// Open the result into a LibreOffice window
HBOFFICE_BROWSE_DOC(NAP_WORK_PATH() + "/../office/ods_gen/Exemple_04.ods")
