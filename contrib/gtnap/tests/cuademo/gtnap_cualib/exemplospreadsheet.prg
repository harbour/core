...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_VALIGN_CENTER)
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_HALIGN_RIGHT)
NAP_XLS_CELL_FONT_FAMILY(O_XLS, N_Page, N_Col, N_Row, "Arial")
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_HALIGN_LEFT)
NAP_XLS_CELL_FONT_FAMILY(O_XLS, N_Page, N_Col, N_Row, "Arial")
NAP_XLS_CELL_FONT_SIZE(O_XLS, N_Page, N_Col, N_Row, 10.0)
NAP_XLS_CELL_BOLD(O_XLS, N_Page, N_Col, N_Row, .T.)
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_HALIGN_RIGHT)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELL_NUMFORMAT(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_NUMFORMAT_INT)
...
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 0, 13, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 0, 14, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 0, 15, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))

NAP_XLS_CELLS_BACKCOLOR(O_XLS, N_Page, 0, 1, 0, 12, NAP_OFFICE_RGB(255, 255, 255))
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 1, 0, 12, HBOFFICE_LINE_STYLE_SOLID, 50, NAP_OFFICE_RGB(0, 0, 0))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 0, 16, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 0, 16, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 16, 0, 18, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 1, 16, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 1, 16, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 1, 16, 7, 16, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 1, 17, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 1, 17, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 1, 17, 1, 18, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 2, 17, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 2, 17, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 2, 17, 2, 18, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 3, 17, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 3, 17, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 3, 17, 6, 17, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 3, 18, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 3, 18, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 3, 18, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 4, 18, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 4, 18, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 4, 18, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 5, 18, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 5, 18, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 5, 18, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 6, 18, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 6, 18, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 6, 18, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 7, 17, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 7, 17, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 7, 17, 7, 18, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 0, 19, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 0, 21, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 0, 22, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
...
NAP_XLS_CELL_NUMFORMAT(O_XLS, N_Page, 1, 21, HBOFFICE_NUMFORMAT_DEC2_1000)
NAP_XLS_CELL_NUMFORMAT(O_XLS, N_Page, 1, 22, HBOFFICE_NUMFORMAT_DEC2_1000)
NAP_XLS_CELL_NUMFORMAT(O_XLS, N_Page, 1, 20, HBOFFICE_NUMFORMAT_DEC2_1000)
...
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 24, 0, 25, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 0, 24, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 0, 24, HBOFFICE_VALIGN_CENTER)
...
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 1, 24, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 1, 24, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 1, 24, HBOFFICE_VALIGN_CENTER)
...
NAP_XLS_CELL_BORDER(O_XLS, N_Page, 1, 25, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(255, 255, 255))
NAP_XLS_CELL_HALIGN(O_XLS, N_Page, 1, 25, HBOFFICE_HALIGN_CENTER)
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 1, 25, HBOFFICE_VALIGN_CENTER)
NAP_XLS_CELL_DATE(O_XLS, N_Page, 1, 25, 31, 10, 2023)
NAP_XLS_CELL_NUMFORMAT(O_XLS, N_Page, 1, 25, HBOFFICE_NUMFORMAT_DATE_SYS_NNNNDMMMMYYYY)
...
// Print spreadsheet
NAP_XLS_PRINT(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Print_03.pdf" }, "", HBOFFICE_PAPER_ORIENT_PORTRAIT, HBOFFICE_PAPER_FORMAT_A4, 0, 0, 1, .F., "1-")
//NAP_XLS_PRINT(O_XLS, {|| NAP_WORK_PATH() + "/../office/ods_gen/Print_02.pdf" }, "Microsoft Print to PDF", HBOFFICE_PAPER_ORIENT_LANSCAPE, HBOFFICE_PAPER_FORMAT_USER, 30000, 60000, 1, .F., "")
...
STAT PROC Value3(O_XLS, N_Page, N_Col, N_Row, N_Value, N_Size, L_Bold)
    ...
    NAP_XLS_CELL_HALIGN(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_HALIGN_RIGHT)
    NAP_XLS_CELL_BOLD(O_XLS, N_Page, N_Col, N_Row, L_Bold)
    NAP_XLS_CELL_NUMFORMAT(O_XLS, N_Page, N_Col, N_Row, HBOFFICE_NUMFORMAT_DEC2_1000)
    NAP_XLS_CELL_VALUE(O_XLS, N_Page, N_Col, N_Row, N_Value)

***********************************
STAT PROC Head3(O_XLS, N_Page, N_Col, N_Row, C_Text)
    Text3(O_XLS, N_Page, N_Col, N_Row, C_Text, HBOFFICE_HALIGN_CENTER, 10, .T.)

***********************************
STAT PROC Title3(O_XLS, N_Page, N_Col, N_Row, C_Text)
    Text3(O_XLS, N_Page, N_Col, N_Row, C_Text, HBOFFICE_HALIGN_LEFT, 10, .F.)

***********************************
STAT PROC TitleB3(O_XLS, N_Page, N_Col, N_Row, C_Text)
    Text3(O_XLS, N_Page, N_Col, N_Row, C_Text, HBOFFICE_HALIGN_LEFT, 10, .T.)
...
// Borders
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 9, 0, 11, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 1, 9, 12, 10, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 13, 9, 13, 11, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 14, 9, 14, 11, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
FOR N_Cont := 1 TO 12
    NAP_XLS_CELL_BORDER(O_XLS, N_Page, N_Cont, 11, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
NEXT
FOR N_Cont := 0 TO 14
    NAP_XLS_CELLS_BORDER(O_XLS, N_Page, N_Cont, 12, N_Cont, 39, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
NEXT
...
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 1, 9, HBOFFICE_VALIGN_CENTER)
...
// Borders
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 0, 6, 0, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 1, 6, 2, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 3, 6, 8, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))
NAP_XLS_CELLS_BORDER(O_XLS, N_Page, 0, 9, 6, 15, HBOFFICE_LINE_STYLE_SOLID, 25, NAP_OFFICE_RGB(0, 0, 0))

// Text
Text4(O_XLS, N_Page, 0, 0, "PREENCHER OS CAMPOS EM CINZA - NÃO ALTERAR A ESTRUTURA DA PLANILHA", HBOFFICE_HALIGN_CENTER, 8, .T.)
Text4(O_XLS, N_Page, 0, 1, "Solicitação de cotação de preços", HBOFFICE_HALIGN_CENTER, 12, .T.)
Text4(O_XLS, N_Page, 0, 2, "Cotação de preços No: 20231129001", HBOFFICE_HALIGN_CENTER, 10, .T.)
Text4(O_XLS, N_Page, 0, 3, "Prefeitura Municipal de Limoeiro do Norte", HBOFFICE_HALIGN_LEFT, 8, .T.)
Text4(O_XLS, N_Page, 0, 5, "RESPONSÁVEL :", HBOFFICE_HALIGN_LEFT, 8, .T.)
Text4(O_XLS, N_Page, 0, 6, "    NOME: CAMILA MARIA MAIA", HBOFFICE_HALIGN_LEFT, 8, .T.)
Text4(O_XLS, N_Page, 0, 9, "PROPONENTE :", HBOFFICE_HALIGN_LEFT, 8, .T.)
Text4(O_XLS, N_Page, 0, 10, "   NOME: CONSTRUTORA LAZIO EIRRELI", HBOFFICE_HALIGN_LEFT, 8, .T.)
Text4(O_XLS, N_Page, 0, 11, "   ENDEREÇO : AV SANTOS DUMONT 1740 SALA 105", HBOFFICE_HALIGN_LEFT, 8, .T.)
Text4(O_XLS, N_Page, 0, 12, "   BAIRRO : ALDEOTA   CIDADE : Fortaleza - CE", HBOFFICE_HALIGN_LEFT, 8, .T.)
Text4(O_XLS, N_Page, 0, 13, "   CNPJ : 10.697.540/0001-20", HBOFFICE_HALIGN_LEFT, 8, .T.)
...
NAP_XLS_CELL_VALIGN(O_XLS, N_Page, 0, 16, HBOFFICE_VALIGN_CENTER)
Text4(O_XLS, N_Page, 0, 16, C_Text, HBOFFICE_HALIGN_LEFT, 8, .F.)

// Text4(O_XLS, N_Page, 0, 16, "O município de Limoeiro do Norte, solicita que seja fornecido os preços unitários e totais do(s) item(ns) abaixo especificado(s), para fins de levantamento preliminar de preços e verificação da modalidade de licitação cabível.", HBOFFICE_HALIGN_LEFT, 8, .F.)
// Text4(O_XLS, N_Page, 1, 21, "Sua resposta, de acordo com os preceitos legais, integrará um processo administrativo de compras, reservando-se a entidade, o direito de adquirir apenas parte do(s) item(ns) discriminado(s), ou rejeitar todos, desde que haja conveniência para o município de Limoeiro do Norte.", HBOFFICE_HALIGN_LEFT, 8, .F.)
// Text4(O_XLS, N_Page, 1, 23, "Limoeiro do Norte, 29 de Novembro de 2023", HBOFFICE_HALIGN_LEFT, 8, .F.)
// Text4(O_XLS, N_Page, 1, 25, "                   ------------------------------------------------------------", HBOFFICE_HALIGN_LEFT, 8, .F.)
// Text4(O_XLS, N_Page, 1, 26, "                   CAMILA MARIA MAIA", HBOFFICE_HALIGN_LEFT, 8, .F.)
// Text4(O_XLS, N_Page, 1, 27, "                   Responsável ", HBOFFICE_HALIGN_LEFT, 8, .F.)
