...
IF C_SubCabec # NIL
    ...
    MOSTRAR(C_CDMENS,C_SubCabec,{GL_ENTER+"=OK"},,.F.,N_SEGUNDOS,"Advertência","adverten.abm")
...
***************************
* NOTA: Os seguintes acentos em código diferente na PC850 e na PC437: "ÁÀÂÃãÊÍÓÔÕõÚ§"
*
LOCAL C_RETORNO
*
IF SOB_MODO_GRAFICO()
...
ELSE
   * Tudo funciona normalmente (acentuação vem correta do "clipboard")
...
***********************
C_Texto := STRTRAN(C_Texto,CHR(141)," ")  // CHR(141)=="ì"

IF SOB_MODO_GRAFICO()

ELSE
   * Tudo funciona normalmente (acentuação vai correta para o "clipboard")
