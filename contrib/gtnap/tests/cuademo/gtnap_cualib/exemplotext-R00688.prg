...
HBOFFICE_DOC_INSERT_IMAGE(O_DOC, HBOFFICE_ANCHOR_AS_CHARACTER, 2000, 2000, HBOFFICE_HALIGN_LEFT, HBOFFICE_VALIGN_CENTER, {|| NAP_WORK_PATH() + "/../office/ods/macapa.png"} )
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
...
// Save the document
HBOFFICE_DOC_SAVE(O_DOC, {|| NAP_WORK_PATH() + "/../office/ods_gen/R00688-PPA.odt" })
OFFICE_ERROR("Erro ao salvar documento de texto")

// Export to PDF
HBOFFICE_DOC_PDF(O_DOC, {|| NAP_WORK_PATH() + "/../office/ods_gen/R00688-PPA.pdf" })
OFFICE_ERROR("Exportando para PDF")

// Print the doc
HBOFFICE_DOC_PRINT(O_DOC, {|| NAP_WORK_PATH() + "/../office/ods_gen/R00688-PPA-Printer.pdf" }, "", HBOFFICE_PAPER_ORIENT_LANSCAPE, HBOFFICE_PAPER_FORMAT_LETTER, 0, 0, 1, .F., "1-")
...
HBOFFICE_BROWSE_DOC(NAP_WORK_PATH() + "/../office/ods_gen/R00688-PPA.odt")
