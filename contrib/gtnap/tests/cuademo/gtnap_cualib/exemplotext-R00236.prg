...
HBOFFICE_DOC_PAGE_HEADER_MARGINS(O_DOC, 0, 0, 508, 102, .T., .T.)
HBOFFICE_DOC_PAGE_FOOTER_SHOW(O_DOC, .T.)
HBOFFICE_DOC_PAGE_FOOTER_MARGINS(O_DOC, 354, 380, 608, 202, .T., .T.)
HBOFFICE_DOC_PAGE_MARGINS(O_DOC, 1270, 178, 1270, 533, 0)
...
HBOFFICE_DOC_INSERT_IMAGE(O_DOC, HBOFFICE_ANCHOR_AT_PARAGRAPH, 2000, 2000, HBOFFICE_HALIGN_LEFT, HBOFFICE_VALIGN_CENTER, {|| NAP_WORK_PATH() + "/../office/ods/macapa.png"} )
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
...
HBOFFICE_DOC_FONT_SIZE(O_DOC, 6.7)
HBOFFICE_DOC_INSERT_TEXT(O_DOC, "Amapá")
HBOFFICE_DOC_INSERT_TEXT(O_DOC, SPACE(52))
HBOFFICE_DOC_INSERT_TEXT(O_DOC, "RESUMO  FINANCEIRO")
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
HBOFFICE_DOC_INSERT_TEXT(O_DOC, "Governo Municipal de Macapá")
HBOFFICE_DOC_INSERT_TEXT(O_DOC, SPACE(23))
HBOFFICE_DOC_INSERT_TEXT(O_DOC, "01/01/2023 a 31/01/2023 - em R$")
HBOFFICE_DOC_INSERT_TEXT(O_DOC, SPACE(39))
HBOFFICE_DOC_INSERT_TEXT(O_DOC, "Página: ")
HBOFFICE_DOC_INSERT_PAGE_NUMBER(O_DOC)
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
HBOFFICE_DOC_INSERT_TEXT(O_DOC, "Prefeitura Municipal de Macapá")
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
HBOFFICE_DOC_INSERT_DASH(O_DOC, N_Width)
HBOFFICE_DOC_INSERT_NEW_LINE(O_DOC)
...
// Save the document
HBOFFICE_DOC_SAVE(O_DOC, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_R00236.odt" })
OFFICE_ERROR("Erro ao salvar documento de texto")

// Export to PDF
HBOFFICE_DOC_PDF(O_DOC, {|| NAP_WORK_PATH() + "/../office/ods_gen/Exemple_R00236.pdf" })
...
HBOFFICE_BROWSE_DOC(NAP_WORK_PATH() + "/../office/ods_gen/Exemple_R00236.odt")
