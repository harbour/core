...
#define EXT_MIME_TABLE_SIZE  258
...
static EXT_MIME_ENTRY s_extMimeTable[ EXT_MIME_TABLE_SIZE ] =
{
   ...
   { "bin"     , MIME_FLAG_CASEINSENS, "application/x-macbinary" },
   ...
   { "css"     , MIME_FLAG_CASEINSENS, "application/x-pointplus" },
   ...
   { "exe"     , MIME_FLAG_CASEINSENS, "application/x-msdownload" },
   ...
   { "mid"     , MIME_FLAG_CASEINSENS, "audio/x-midi" },
   { "midi"    , MIME_FLAG_CASEINSENS, "audio/x-midi" },
   ...
   { "mp3"     , MIME_FLAG_CASEINSENS, "audio/x-mpeg" },
   ...
   { "pdb"     , MIME_FLAG_CASEINSENS, "chemical/x-pdb" },
   ...
   { "ppt"     , MIME_FLAG_CASEINSENS, "application/mspowerpoint" },
   ...
   { "ra"      , MIME_FLAG_CASEINSENS, "audio/x-pn-realaudio" },
   { "ram"     , MIME_FLAG_CASEINSENS, "audio/x-pn-realaudio" },
   ...
   { "rpm"     , MIME_FLAG_CASEINSENS, "audio/x-pn-realaudio-plugin" },
